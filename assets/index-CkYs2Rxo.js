var Ie=(a,i)=>()=>(i||a((i={exports:{}}).exports,i),i.exports);import{a as Le,g as Oe,r as u,j as e,A as ge,m as A,L as Ge,R as $e}from"./vendor-CYOoJq99.js";import{M as Se,S as Ne,W as Ve,T as Ze,F as K,c as _e,a as Ue,P as Me,b as Fe,d as I,e as pe,I as Be,f as q,g as Ye,X as he,L as Ke,h as Xe,i as Qe,C as Ae,A as qe,j as Z,R as Je,k as et,E as xe,l as me,m as ae,n as Ee,V as tt,o as Q,p as ue,q as nt,r as De,s as Te,t as st,Q as it,u as We,v as ot}from"./icons-DFhTEGkF.js";var Dt=Ie((Ht,oe)=>{(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))d(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&d(l)}).observe(document,{childList:!0,subtree:!0});function o(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function d(t){if(t.ep)return;t.ep=!0;const r=o(t);fetch(t.href,r)}})();var se={},Re;function at(){if(Re)return se;Re=1;var a=Le();return se.createRoot=a.createRoot,se.hydrateRoot=a.hydrateRoot,se}var rt=at();const lt=Oe(rt);function dt({onLoaded:a}){const[i,o]=u.useState(0),[d,t]=u.useState(!1),[r,l]=u.useState(!1);return u.useEffect(()=>{let g=0;const m=setInterval(()=>{g+=Math.random()*25+10,g>=100?(g=100,o(100),clearInterval(m),setTimeout(()=>{t(!0),setTimeout(()=>{l(!0),a&&a()},400)},300)):o(Math.floor(g))},100),n=setTimeout(()=>{o(100),t(!0),setTimeout(()=>{l(!0),a&&a()},400)},2200);return()=>{clearInterval(m),clearTimeout(n)}},[a]),r?null:e.jsx("div",{className:`preloader ${d?"hidden":""}`,id:"preloader","aria-hidden":d,children:e.jsxs("div",{className:"preloader__inner",children:[e.jsx("div",{className:"preloader__logo",children:e.jsx("span",{className:"preloader__text","data-text":"shahd.ic",children:"shahd.ic"})}),e.jsx("div",{className:"preloader__bar",children:e.jsx("span",{style:{width:`${i}%`}})})]})})}function ct({theme:a="light"}){const i=u.useRef(null),o=a==="dark";return u.useEffect(()=>{const d=i.current;if(!d)return;const t=d.getContext("2d");if(!t)return;let r;const l=typeof window<"u"&&window.devicePixelRatio||1;let g=window.innerWidth,m=window.innerHeight;d.width=g*l,d.height=m*l,t.scale(l,l);const n=()=>{d&&(g=window.innerWidth,m=window.innerHeight,d.width=g*l,d.height=m*l,t.scale(l,l))};window.addEventListener("resize",n);let f=g/2,v=m/2,S=g/2,w=m/2;const _=h=>{S=h.clientX,w=h.clientY};window.addEventListener("mousemove",_,{passive:!0});const B=Array.from({length:o?280:90},()=>{const h=Math.random()*.85+.15,p=o&&h>.8&&Math.random()>.55;return{x:Math.random()*g,y:Math.random()*m,size:Math.random()*1.7*h+.6,vx:(Math.random()*.18+.05)*h,vy:(Math.random()*.08-.02)*h,depth:h,isSparkle:p,baseAlpha:Math.random()*.5+(o?.4:.18),twinkleSpeed:Math.random()*.035+.015,twinkleOffset:Math.random()*Math.PI*2,color:h>.8?"#FFFFFF":h>.5?Math.random()>.4?"#7DD3FC":"#38BDF8":Math.random()>.5?"#FDE047":"#C084FC"}}),R=[];let T=Date.now()+Math.random()*2500+1e3;const O=()=>{const h=Math.random()*g*.8+g*.1,p=Math.random()*m*.4,k=Math.PI/4+(Math.random()*.2-.1),x=Math.random()*15+16,F=Math.random()*120+80;R.push({x:h,y:p,vx:Math.cos(k)*x,vy:Math.sin(k)*x,length:F,life:1,decay:Math.random()*.024+.016,color:Math.random()>.35?"#38BDF8":"#FFFFFF"})};let G=0;const c=()=>{t.clearRect(0,0,g,m),G+=1,f+=(S-f)*.04,v+=(w-v)*.04;const h=(f-g/2)*.015,p=(v-m/2)*.015;for(let k=0;k<B.length;k++){const x=B[k];x.x+=x.vx,x.y+=x.vy,x.x>g+15&&(x.x=-15),x.x<-15&&(x.x=g+15),x.y>m+15&&(x.y=-15),x.y<-15&&(x.y=m+15);const F=x.x-h*x.depth,W=x.y-p*x.depth,z=Math.max(.12,Math.min(1,x.baseAlpha+Math.sin(G*x.twinkleSpeed+x.twinkleOffset)*.42));if(t.fillStyle=x.color,t.globalAlpha=z,t.beginPath(),t.arc(F,W,x.size,0,Math.PI*2),t.fill(),o&&x.isSparkle&&z>.65){const V=x.size*3.2;t.beginPath(),t.arc(F,W,V,0,Math.PI*2),t.fillStyle="rgba(56, 189, 248, 0.22)",t.fill();const L=x.size*5.5;t.strokeStyle=`rgba(255, 255, 255, ${z*.75})`,t.lineWidth=.8,t.beginPath(),t.moveTo(F-L,W),t.lineTo(F+L,W),t.moveTo(F,W-L),t.lineTo(F,W+L),t.stroke()}}if(o){Date.now()>T&&(O(),T=Date.now()+Math.random()*4e3+2e3);for(let k=R.length-1;k>=0;k--){const x=R[k];if(x.x+=x.vx,x.y+=x.vy,x.life-=x.decay,x.life<=0||x.x>g+100||x.y>m+100){R.splice(k,1);continue}const F=x.x-x.vx/18*x.length,W=x.y-x.vy/18*x.length,z=t.createLinearGradient(x.x,x.y,F,W);z.addColorStop(0,x.color),z.addColorStop(.25,`rgba(56, 189, 248, ${x.life*.9})`),z.addColorStop(1,"rgba(255, 255, 255, 0)"),t.globalAlpha=x.life,t.strokeStyle=z,t.lineWidth=2.2,t.beginPath(),t.moveTo(x.x,x.y),t.lineTo(F,W),t.stroke(),t.fillStyle="#FFFFFF",t.beginPath(),t.arc(x.x,x.y,2.2,0,Math.PI*2),t.fill()}}t.globalAlpha=1,r=requestAnimationFrame(c)};return c(),()=>{window.removeEventListener("resize",n),window.removeEventListener("mousemove",_),cancelAnimationFrame(r)}},[o]),e.jsxs("div",{className:`sky ${o?"sky--dark":"sky--light"}`,id:"sky","aria-hidden":"true",children:[e.jsx("canvas",{ref:i,style:{position:"absolute",inset:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:1}}),e.jsx("div",{className:"sky__glow"}),e.jsxs("div",{className:"sky__clouds-layer",children:[e.jsx("div",{className:"sky-floating-cloud sky-floating-cloud--1"}),e.jsx("div",{className:"sky-floating-cloud sky-floating-cloud--2"}),e.jsx("div",{className:"sky-floating-cloud sky-floating-cloud--3"})]}),o&&e.jsxs("div",{className:"sky-3d-backdrop sky-3d--dark hidden md:block","aria-hidden":"true",children:[e.jsx("div",{className:"bg-3d-element bg-3d-element--top-left",children:e.jsxs("div",{className:"bg-3d-cosmic-cube",children:[e.jsx("div",{className:"cube-face cube-face--front"}),e.jsx("div",{className:"cube-face cube-face--back"}),e.jsx("div",{className:"cube-face cube-face--right"}),e.jsx("div",{className:"cube-face cube-face--left"}),e.jsx("div",{className:"cube-face cube-face--top"}),e.jsx("div",{className:"cube-face cube-face--bottom"}),e.jsx("div",{className:"cube-glow-core"})]})}),e.jsx("div",{className:"bg-3d-element bg-3d-element--bottom-left",children:e.jsxs("div",{className:"bg-3d-saturn",children:[e.jsx("div",{className:"saturn-body"}),e.jsx("div",{className:"saturn-ring saturn-ring--1"}),e.jsx("div",{className:"saturn-ring saturn-ring--2"})]})}),e.jsx("div",{className:"bg-3d-element bg-3d-element--mid-left",children:e.jsxs("div",{className:"bg-3d-astral-prism",children:[e.jsx("div",{className:"prism-facet prism-facet--top"}),e.jsx("div",{className:"prism-facet prism-facet--bottom"})]})})]})]})}function pt(){const[a,i]=u.useState(0);return u.useEffect(()=>{const o=()=>{const d=window.scrollY||document.documentElement.scrollTop,t=document.documentElement.scrollHeight-document.documentElement.clientHeight;if(t>0){const r=Math.min(100,Math.max(0,d/t*100));i(r)}};return window.addEventListener("scroll",o,{passive:!0}),o(),()=>window.removeEventListener("scroll",o)},[]),e.jsx("div",{className:"scroll-progress",id:"scrollProgress",style:{width:`${a}%`}})}function ht(){const[a,i]=u.useState(!1);u.useEffect(()=>{const d=()=>{i(window.scrollY>400)};return window.addEventListener("scroll",d,{passive:!0}),d(),()=>window.removeEventListener("scroll",d)},[]);const o=()=>{window.scrollTo({top:0,behavior:"smooth"})};return e.jsx("button",{className:`back-to-top ${a?"visible":""}`,id:"backToTop","aria-label":"Back to top",onClick:o,children:e.jsx("i",{className:"fa-solid fa-arrow-up"})})}function xt({isLoaded:a,theme:i="light",onToggleTheme:o}){const[d,t]=u.useState(!1),[r,l]=u.useState("home"),[g,m]=u.useState(!1);u.useEffect(()=>{const v=()=>{m(window.scrollY>30);const S=["home","about","services","process","contact"],w=window.scrollY+180;for(let _=S.length-1;_>=0;_--){const C=document.getElementById(S[_]);if(C){const B=C.offsetTop;if(w>=B){l(S[_]);break}}}};return window.addEventListener("scroll",v,{passive:!0}),v(),()=>window.removeEventListener("scroll",v)},[]);const n=()=>t(v=>!v),f=()=>t(!1);return e.jsxs(e.Fragment,{children:[e.jsx("nav",{className:`navbar ${a?"nav-visible":""} ${g?"nav-scrolled backdrop-blur-xl":""}`,id:"navbar",children:e.jsxs("div",{className:"container nav-container",children:[e.jsxs("a",{href:"#home",className:"nav-logo group",onClick:f,children:[e.jsx("span",{className:"nav-logo__mark transition-transform group-hover:scale-105 inline-block",children:"shahd"}),e.jsx("span",{className:"nav-logo__dot",children:".ic"})]}),e.jsxs("ul",{className:`nav-links ${d?"active open":""}`,id:"navLinks",children:[["home","about","services","process","contact"].map(v=>e.jsx("li",{children:e.jsx("a",{href:`#${v}`,className:`nav-link capitalize ${r===v?"active":""}`,onClick:f,children:v==="home"?"Home":v==="about"?"About":v==="services"?"Services":v==="process"?"Process":"Contact"})},v)),e.jsx("li",{className:"nav-mobile-theme-row",children:e.jsxs("button",{type:"button",onClick:()=>{o()},className:"w-full flex items-center justify-between px-4 py-3 rounded-xl bg-white/10 hover:bg-white/15 border border-white/10 text-white font-semibold text-xs transition-all cursor-pointer",children:[e.jsxs("span",{className:"flex items-center gap-2",children:[i==="dark"?e.jsx(Se,{className:"w-4 h-4 text-sky-400"}):e.jsx(Ne,{className:"w-4 h-4 text-amber-400"}),e.jsx("span",{children:i==="dark"?"Night Theme":"Day Theme"})]}),e.jsx("span",{className:"text-[11px] font-bold text-sky-300 bg-sky-500/20 border border-sky-500/30 px-2.5 py-1 rounded-full",children:i==="dark"?"Day Mode ☀️":"Night Mode 🌙"})]})}),e.jsx("li",{className:"nav-mobile-cta",children:e.jsxs("a",{href:"https://wa.me/201092916162",target:"_blank",rel:"noopener noreferrer",className:"btn btn-primary btn--nav-mobile flex items-center justify-center gap-2",onClick:f,children:[e.jsx("i",{className:"bi bi-whatsapp"}),e.jsx("span",{children:"Chat on WhatsApp"})]})})]}),e.jsxs("div",{className:"nav-actions flex items-center gap-2.5",children:[e.jsx("button",{onClick:o,className:"theme-toggle-btn w-9 h-9 rounded-full flex items-center justify-center transition-all bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/40 text-white shadow-sm hover:scale-105 active:scale-95 cursor-pointer",title:i==="dark"?"Switch to Day Mode":"Switch to Dark Mode","aria-label":i==="dark"?"Switch to Day Mode":"Switch to Dark Mode",children:e.jsx(ge,{mode:"wait",children:i==="dark"?e.jsx(A.div,{initial:{rotate:-90,scale:.6,opacity:0},animate:{rotate:0,scale:1,opacity:1},exit:{rotate:90,scale:.6,opacity:0},transition:{duration:.2},children:e.jsx(Se,{className:"w-4 h-4 text-sky-300"})},"moon"):e.jsx(A.div,{initial:{rotate:90,scale:.6,opacity:0},animate:{rotate:0,scale:1,opacity:1},exit:{rotate:-90,scale:.6,opacity:0},transition:{duration:.2},children:e.jsx(Ne,{className:"w-4 h-4 text-amber-300"})},"sun")})}),e.jsx("a",{href:"https://wa.me/201092916162",target:"_blank",rel:"noopener noreferrer",className:"nav-social hover:scale-110 active:scale-95 transition-transform","data-platform":"whatsapp","aria-label":"WhatsApp",children:e.jsx("svg",{viewBox:"0 0 24 24",width:"20",height:"20",fill:"currentColor","aria-hidden":"true",children:e.jsx("path",{d:"M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2zm.01 1.67c2.2 0 4.26.86 5.82 2.42a8.225 8.225 0 0 1 2.41 5.83c0 4.54-3.7 8.24-8.24 8.24-1.48 0-2.93-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.196 8.196 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.24-8.24zm4.52 11.66c-.25-.13-1.47-.72-1.7-.81-.23-.08-.39-.13-.56.13-.17.25-.64.81-.79.97-.14.17-.29.19-.54.06-.25-.13-1.06-.39-2.02-1.25-.75-.67-1.26-1.5-1.41-1.75-.15-.25-.02-.39.11-.51.11-.11.25-.29.37-.44.13-.15.17-.25.25-.42.08-.17.04-.31-.02-.44-.06-.13-.56-1.35-.77-1.85-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.44.06-.67.31-.23.25-.88.86-.88 2.1 0 1.24.9 2.44 1.03 2.61.13.17 1.77 2.71 4.3 3.8.6.26 1.07.41 1.44.53.61.19 1.16.17 1.6-.1.49-.3 1.47-1.2 1.68-1.66.21-.46.21-.86.15-.98-.06-.13-.23-.2-.48-.32z"})})})]}),e.jsxs("button",{className:`nav-toggle ${d?"active":""}`,id:"navToggle","aria-label":"Toggle navigation menu","aria-expanded":d,onClick:n,children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})]})}),e.jsx("div",{className:`nav-overlay ${d?"active":""}`,id:"navOverlay","aria-hidden":!d,onClick:f})]})}function gt({onOpenFolder:a}){const i=u.useRef(null),o=u.useRef(null),d=r=>{var n;i.current&&(i.current.classList.remove("knocking"),i.current.offsetWidth,i.current.classList.add("knocking"),setTimeout(()=>{i.current&&i.current.classList.remove("knocking")},900));const l=(n=o.current)==null?void 0:n.getBoundingClientRect(),g=l?(l.left+l.width/2)/window.innerWidth:.5,m=l?(l.top+l.height/2)/window.innerHeight:.5;_e({origin:{x:g,y:m},particleCount:45,spread:80,startVelocity:30,gravity:.65,ticks:200,scalar:1.2,shapes:["star","circle"],colors:["#38BDF8","#F43F5E","#FBBF24","#34D399","#C084FC","#FFFFFF"]}),setTimeout(()=>{_e({origin:{x:g,y:m-.05},particleCount:20,spread:60,startVelocity:22,scalar:.9,shapes:["star"],colors:["#FEF08A","#FDE68A","#7DD3FC"]})},120)},t=r=>{(r.key==="Enter"||r.key===" ")&&(r.preventDefault(),d())};return e.jsx("section",{className:"hero",id:"home",children:e.jsxs("div",{className:"container hero__layout",children:[e.jsxs(A.div,{className:"hero__content",initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.8,ease:[.16,1,.3,1]},children:[e.jsxs(A.div,{className:"hero__badge",initial:{opacity:0,scale:.9},animate:{opacity:1,scale:1},transition:{delay:.2,duration:.6},children:[e.jsx("span",{className:"hero__badge-dot"}),e.jsx("span",{children:"Available for Strategic Growth & Collaborations"})]}),e.jsxs(A.h1,{className:"hero__title",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.3,duration:.8},children:["I craft ",e.jsx("span",{className:"gradient-text hero-highlight",children:"scroll‑stopping"})," content & viral growth."]}),e.jsxs(A.p,{className:"hero__intro",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.45,duration:.8},children:["I'm ",e.jsx("strong",{children:"Shahd Essam"})," — Freelance Social Media Specialist & Content Creator helping ambitious brands build a strong online presence through creative content, strategy development, and audience-focused communication."]}),e.jsxs(A.div,{className:"hero__tags-bar",initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{delay:.6,duration:.8},children:[e.jsxs("span",{className:"hero__tag-item",children:[e.jsx(Ve,{className:"w-4 h-4 text-sky-300 inline-block mr-1.5"})," Viral Video Scripting"]}),e.jsxs("span",{className:"hero__tag-item",children:[e.jsx(Ze,{className:"w-4 h-4 text-emerald-400 inline-block mr-1.5"})," Acquisition Funnels"]}),e.jsxs("span",{className:"hero__tag-item",children:[e.jsx(K,{className:"w-4 h-4 text-amber-400 inline-block mr-1.5"})," High-Retention Hooks"]})]}),e.jsxs("div",{className:"hero__scroll",children:[e.jsx("span",{children:"Scroll to Explore"}),e.jsx("div",{className:"hero__scroll-line",children:e.jsx("span",{})})]})]}),e.jsxs("div",{className:"hero__visual",children:[e.jsx("div",{className:"hero-floating-stage",id:"heroFloatingStage",children:e.jsxs(A.div,{className:"hero-figure-wrapper cursor-pointer",id:"heroFigureWrapper",ref:o,role:"button",tabIndex:0,"aria-label":"Shahd Essam — Wait... I have an idea. (Click for Magic Stars)",onClick:d,onKeyDown:t,whileHover:{scale:1.03},whileTap:{scale:.98},children:[e.jsxs("div",{className:"hero-wood-swing",id:"heroWoodSwing",ref:i,children:[e.jsx("div",{className:"hero-figure-sheen","aria-hidden":"true"}),e.jsx("img",{src:"/shahd.ic/image/shahd_idea_nobg.png",alt:"Shahd Essam — Wait... I have an idea.",className:"hero-floating-img",id:"heroFloatingImg",loading:"eager"}),e.jsxs("div",{className:"hero-figure-sparkles","aria-hidden":"true",children:[e.jsx("span",{className:"hero-spark hero-spark--1",children:"✦"}),e.jsx("span",{className:"hero-spark hero-spark--2",children:"⭐"}),e.jsx("span",{className:"hero-spark hero-spark--3",children:"✧"}),e.jsx("span",{className:"hero-spark hero-spark--4",children:"✨"}),e.jsx("span",{className:"hero-spark hero-spark--5",children:"★"}),e.jsx("span",{className:"hero-spark hero-spark--6",children:"💫"})]})]}),e.jsx("div",{className:"hero-ground-shadow","aria-hidden":"true"})]})}),e.jsxs("div",{className:"hero-xp-folders","aria-hidden":"false",children:[e.jsxs("button",{type:"button",className:"xp-folder hero-sector-folder xp-folder--1 xp-folder--pink cursor-pointer",title:"01_Healthcare_Medical (5 Dossiers)",onClick:r=>{r.stopPropagation(),a("medical")},children:[e.jsxs("div",{className:"xp-folder__icon-box",children:[e.jsxs("svg",{className:"xp-folder__svg",viewBox:"0 0 64 52",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("path",{d:"M4 8C4 5.79 5.79 4 8 4H24L30 10H56C58.21 10 60 11.79 60 14V44C60 46.21 58.21 48 56 48H8C5.79 48 4 46.21 4 44V8Z",fill:"url(#xpBack1)",stroke:"#B38006",strokeWidth:"1.2"}),e.jsx("rect",{x:"10",y:"8",width:"44",height:"20",rx:"2",fill:"#FFFFFF",opacity:"0.95"}),e.jsx("line",{x1:"14",y1:"12",x2:"32",y2:"12",stroke:"#FDA4AF",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("line",{x1:"14",y1:"16",x2:"44",y2:"16",stroke:"#CBD5E1",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("path",{d:"M2 18L6 45.5C6.3 47.5 8 49 10 49H54C56 49 57.7 47.5 58 45.5L62 18C62.3 16 60.5 14 58.5 14H5.5C3.5 14 1.7 16 2 18Z",fill:"url(#xpFront1)",stroke:"#B38006",strokeWidth:"1.2"}),e.jsx("path",{d:"M6 16.5H58",stroke:"#FFF7C2",strokeWidth:"1.5",strokeLinecap:"round",opacity:"0.9"}),e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"xpBack1",x1:"4",y1:"4",x2:"60",y2:"48",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{stopColor:"#FFDF5D"}),e.jsx("stop",{offset:"0.5",stopColor:"#F5B800"}),e.jsx("stop",{offset:"1",stopColor:"#D99B00"})]}),e.jsxs("linearGradient",{id:"xpFront1",x1:"2",y1:"14",x2:"62",y2:"49",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{stopColor:"#FFF18E"}),e.jsx("stop",{offset:"0.3",stopColor:"#FFD738"}),e.jsx("stop",{offset:"0.8",stopColor:"#F2A900"}),e.jsx("stop",{offset:"1",stopColor:"#C78200"})]})]})]}),e.jsx("span",{className:"xp-folder__mini-pill xp-folder__mini-pill--pink",children:e.jsx("i",{className:"fa-solid fa-heart-pulse"})})]}),e.jsx("span",{className:"xp-folder__text",children:"01_Medical_Sector.dir"})]}),e.jsxs("button",{type:"button",className:"xp-folder hero-sector-folder xp-folder--2 xp-folder--cyan cursor-pointer",title:"02_Commercial_Retail (3 Dossiers)",onClick:r=>{r.stopPropagation(),a("commercial")},children:[e.jsxs("div",{className:"xp-folder__icon-box",children:[e.jsxs("svg",{className:"xp-folder__svg",viewBox:"0 0 64 52",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("path",{d:"M4 8C4 5.79 5.79 4 8 4H24L30 10H56C58.21 10 60 11.79 60 14V44C60 46.21 58.21 48 56 48H8C5.79 48 4 46.21 4 44V8Z",fill:"url(#xpBack2)",stroke:"#B38006",strokeWidth:"1.2"}),e.jsx("rect",{x:"10",y:"8",width:"44",height:"20",rx:"2",fill:"#FFFFFF",opacity:"0.95"}),e.jsx("line",{x1:"14",y1:"12",x2:"30",y2:"12",stroke:"#7DD3FC",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("line",{x1:"14",y1:"16",x2:"42",y2:"16",stroke:"#CBD5E1",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("path",{d:"M2 18L6 45.5C6.3 47.5 8 49 10 49H54C56 49 57.7 47.5 58 45.5L62 18C62.3 16 60.5 14 58.5 14H5.5C3.5 14 1.7 16 2 18Z",fill:"url(#xpFront2)",stroke:"#B38006",strokeWidth:"1.2"}),e.jsx("path",{d:"M6 16.5H58",stroke:"#FFF7C2",strokeWidth:"1.5",strokeLinecap:"round",opacity:"0.9"}),e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"xpBack2",x1:"4",y1:"4",x2:"60",y2:"48",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{stopColor:"#FFDF5D"}),e.jsx("stop",{offset:"0.5",stopColor:"#F5B800"}),e.jsx("stop",{offset:"1",stopColor:"#D99B00"})]}),e.jsxs("linearGradient",{id:"xpFront2",x1:"2",y1:"14",x2:"62",y2:"49",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{stopColor:"#FFF18E"}),e.jsx("stop",{offset:"0.3",stopColor:"#FFD738"}),e.jsx("stop",{offset:"0.8",stopColor:"#F2A900"}),e.jsx("stop",{offset:"1",stopColor:"#C78200"})]})]})]}),e.jsx("span",{className:"xp-folder__mini-pill xp-folder__mini-pill--cyan",children:e.jsx("i",{className:"fa-solid fa-cart-shopping"})})]}),e.jsx("span",{className:"xp-folder__text",children:"02_Commercial_Retail.dir"})]}),e.jsxs("button",{type:"button",className:"xp-folder hero-sector-folder xp-folder--3 xp-folder--gold cursor-pointer",title:"03_Food_Dining (4 Dossiers)",onClick:r=>{r.stopPropagation(),a("food")},children:[e.jsxs("div",{className:"xp-folder__icon-box",children:[e.jsxs("svg",{className:"xp-folder__svg",viewBox:"0 0 64 52",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("path",{d:"M4 8C4 5.79 5.79 4 8 4H24L30 10H56C58.21 10 60 11.79 60 14V44C60 46.21 58.21 48 56 48H8C5.79 48 4 46.21 4 44V8Z",fill:"url(#xpBack3)",stroke:"#B38006",strokeWidth:"1.2"}),e.jsx("rect",{x:"10",y:"8",width:"44",height:"20",rx:"2",fill:"#FFFFFF",opacity:"0.95"}),e.jsx("line",{x1:"14",y1:"12",x2:"28",y2:"12",stroke:"#FDE68A",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("line",{x1:"14",y1:"16",x2:"40",y2:"16",stroke:"#CBD5E1",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("path",{d:"M2 18L6 45.5C6.3 47.5 8 49 10 49H54C56 49 57.7 47.5 58 45.5L62 18C62.3 16 60.5 14 58.5 14H5.5C3.5 14 1.7 16 2 18Z",fill:"url(#xpFront3)",stroke:"#B38006",strokeWidth:"1.2"}),e.jsx("path",{d:"M6 16.5H58",stroke:"#FFF7C2",strokeWidth:"1.5",strokeLinecap:"round",opacity:"0.9"}),e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"xpBack3",x1:"4",y1:"4",x2:"60",y2:"48",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{stopColor:"#FFDF5D"}),e.jsx("stop",{offset:"0.5",stopColor:"#F5B800"}),e.jsx("stop",{offset:"1",stopColor:"#D99B00"})]}),e.jsxs("linearGradient",{id:"xpFront3",x1:"2",y1:"14",x2:"62",y2:"49",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{stopColor:"#FFF18E"}),e.jsx("stop",{offset:"0.3",stopColor:"#FFD738"}),e.jsx("stop",{offset:"0.8",stopColor:"#F2A900"}),e.jsx("stop",{offset:"1",stopColor:"#C78200"})]})]})]}),e.jsx("span",{className:"xp-folder__mini-pill xp-folder__mini-pill--gold",children:e.jsx("i",{className:"fa-solid fa-utensils"})})]}),e.jsx("span",{className:"xp-folder__text",children:"03_Food_Dining.dir"})]}),e.jsxs("button",{type:"button",className:"xp-folder hero-sector-folder xp-folder--4 xp-folder--purple cursor-pointer",title:"04_Brand_Strategy_RealEstate (Dossier)",onClick:r=>{r.stopPropagation(),a("realestate")},children:[e.jsxs("div",{className:"xp-folder__icon-box",children:[e.jsxs("svg",{className:"xp-folder__svg",viewBox:"0 0 64 52",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[e.jsx("path",{d:"M4 8C4 5.79 5.79 4 8 4H24L30 10H56C58.21 10 60 11.79 60 14V44C60 46.21 58.21 48 56 48H8C5.79 48 4 46.21 4 44V8Z",fill:"url(#xpBack4)",stroke:"#B38006",strokeWidth:"1.2"}),e.jsx("rect",{x:"10",y:"8",width:"44",height:"20",rx:"2",fill:"#FFFFFF",opacity:"0.95"}),e.jsx("line",{x1:"14",y1:"12",x2:"34",y2:"12",stroke:"#C4B5FD",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("line",{x1:"14",y1:"16",x2:"42",y2:"16",stroke:"#CBD5E1",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("path",{d:"M2 18L6 45.5C6.3 47.5 8 49 10 49H54C56 49 57.7 47.5 58 45.5L62 18C62.3 16 60.5 14 58.5 14H5.5C3.5 14 1.7 16 2 18Z",fill:"url(#xpFront4)",stroke:"#B38006",strokeWidth:"1.2"}),e.jsx("path",{d:"M6 16.5H58",stroke:"#FFF7C2",strokeWidth:"1.5",strokeLinecap:"round",opacity:"0.9"}),e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"xpBack4",x1:"4",y1:"4",x2:"60",y2:"48",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{stopColor:"#FFDF5D"}),e.jsx("stop",{offset:"0.5",stopColor:"#F5B800"}),e.jsx("stop",{offset:"1",stopColor:"#D99B00"})]}),e.jsxs("linearGradient",{id:"xpFront4",x1:"2",y1:"14",x2:"62",y2:"49",gradientUnits:"userSpaceOnUse",children:[e.jsx("stop",{stopColor:"#FFF18E"}),e.jsx("stop",{offset:"0.3",stopColor:"#FFD738"}),e.jsx("stop",{offset:"0.8",stopColor:"#F2A900"}),e.jsx("stop",{offset:"1",stopColor:"#C78200"})]})]})]}),e.jsx("span",{className:"xp-folder__mini-pill xp-folder__mini-pill--purple",children:e.jsx("i",{className:"fa-solid fa-chess-knight"})})]}),e.jsx("span",{className:"xp-folder__text",children:"04_Brand_Strategy.dir"})]})]})]})]})})}function mt(){return e.jsx("section",{className:"section about",id:"about",children:e.jsxs("div",{className:"container",children:[e.jsxs(A.div,{className:"section-head",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.7},children:[e.jsx("span",{className:"section-tag",children:"01 — WHO AM I ?"}),e.jsxs("h2",{className:"section-title",children:["YOUR BRAND. ",e.jsx("span",{className:"gradient-text",children:"MY STRATEGY."})]})]}),e.jsxs("div",{className:"about__triptych",children:[e.jsx(A.div,{className:"about__pillar-col about__pillar-col--left",initial:{opacity:0,x:-35},whileInView:{opacity:1,x:0},viewport:{once:!0},transition:{duration:.8,delay:.1},children:e.jsx("div",{className:"about__pillar-card hover:scale-[1.02] transition-transform duration-300",children:e.jsxs("div",{className:"about__pillar-frame",children:[e.jsx("img",{src:"/shahd.ic/image/shahd_strategy.jpg",alt:"Shahd Essam — Strategy Creates Clarity",className:"about__pillar-img",loading:"eager"}),e.jsxs("div",{className:"about__pillar-badge about__pillar-badge--blue",children:[e.jsx("i",{className:"fa-solid fa-chess"})," ",e.jsx("span",{children:"Strategy"})]}),e.jsx("div",{className:"about__pillar-quote-box",children:e.jsxs("span",{className:"about__pillar-quote",children:[e.jsx("i",{className:"fa-solid fa-heart about__heart--blue"})," Strategy Creates Clarity."]})})]})})}),e.jsx(A.div,{className:"about__center-col",initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.8,delay:.2},children:e.jsxs("div",{className:"about__bio-card backdrop-blur-xl border border-sky-400/30 hover:border-sky-400/50 transition-colors",children:[e.jsx("span",{className:"about__subtitle-badge",children:"Freelance Social Media Specialist & Content Creator"}),e.jsxs("div",{className:"about__bio-paragraphs",children:[e.jsxs("p",{className:"about__bio-p",children:["I specialize in ",e.jsx("strong",{className:"text-highlight",children:"content creation"}),","," ",e.jsx("strong",{className:"text-highlight",children:"strategy development"}),", and"," ",e.jsx("strong",{className:"text-highlight",children:"social media management"}),"."]}),e.jsxs("p",{className:"about__bio-p",children:["I help brands build a strong online presence through"," ",e.jsx("strong",{className:"text-highlight",children:"creative content"})," and"," ",e.jsx("strong",{className:"text-highlight",children:"audience-focused communication"}),"."]}),e.jsxs("p",{className:"about__bio-p",children:["Driven by ",e.jsx("strong",{className:"text-highlight",children:"creativity"}),","," ",e.jsx("strong",{className:"text-highlight",children:"adaptability"}),", and"," ",e.jsx("strong",{className:"text-highlight",children:"continuous learning"}),", I create content that delivers real impact."]})]}),e.jsxs("div",{className:"about__center-meta",children:[e.jsx("h3",{className:"about__creator-name",children:"SHAHD ESSAM"}),e.jsx("p",{className:"about__creator-role",children:"Freelance Social Media Specialist & Content Creator"})]})]})}),e.jsx(A.div,{className:"about__pillar-col about__pillar-col--right",initial:{opacity:0,x:35},whileInView:{opacity:1,x:0},viewport:{once:!0},transition:{duration:.8,delay:.1},children:e.jsx("div",{className:"about__pillar-card hover:scale-[1.02] transition-transform duration-300",children:e.jsxs("div",{className:"about__pillar-frame",children:[e.jsx("img",{src:"/shahd.ic/image/shahd_content.jpg",alt:"Shahd Essam — Content Connects People",className:"about__pillar-img",loading:"eager"}),e.jsxs("div",{className:"about__pillar-badge about__pillar-badge--pink",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"})," ",e.jsx("span",{children:"Content"})]}),e.jsx("div",{className:"about__pillar-quote-box",children:e.jsxs("span",{className:"about__pillar-quote",children:[e.jsx("i",{className:"fa-solid fa-heart about__heart--pink"})," Content Connects People."]})})]})})})]})]})})}const ie=[{icon:"fa-solid fa-bullhorn",title:"Social Media Management",desc:"Full-channel growth, calendars & active community engagement."},{icon:"fa-solid fa-clapperboard",title:"Content Creation",desc:"Scroll-stopping visuals, dynamic graphics & viral video content."},{icon:"fa-solid fa-chess",title:"Content Strategy",desc:"Data-driven roadmaps tuned to audience psychology & algorithms."},{icon:"fa-solid fa-rocket",title:"Creative Campaigns",desc:"Bold, unconventional campaigns from concept to measurable impact."},{icon:"fa-solid fa-film",title:"Reels / Short-form Content",desc:"High-retention reels & shorts built for hooks, virality & reach."},{icon:"fa-solid fa-fingerprint",title:"Personal Branding",desc:"Magnetic positioning, distinct voice & memorable visual identity."}];function ut(){const[a,i]=u.useState(()=>typeof window<"u"?window.innerWidth<=768:!1),[o,d]=u.useState(!1);u.useEffect(()=>{const l=()=>{i(window.innerWidth<=768)};return window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[]);const t=a&&!o?ie.slice(0,3):ie,r=a&&!o&&ie.length>3;return e.jsxs("section",{className:"section services",id:"services",children:[e.jsx("svg",{width:"0",height:"0",style:{position:"absolute",pointerEvents:"none"},"aria-hidden":"true",children:e.jsxs("defs",{children:[e.jsxs("linearGradient",{id:"cloudBgGrad",x1:"0%",y1:"0%",x2:"0%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"#FFFFFF"}),e.jsx("stop",{offset:"68%",stopColor:"#F8FAFC"}),e.jsx("stop",{offset:"100%",stopColor:"#E2EDF8"})]}),e.jsxs("linearGradient",{id:"cloudBgGradHover",x1:"0%",y1:"0%",x2:"0%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"#FFFFFF"}),e.jsx("stop",{offset:"70%",stopColor:"#F0F9FF"}),e.jsx("stop",{offset:"100%",stopColor:"#D9EEFD"})]}),e.jsxs("linearGradient",{id:"cloudBorderGrad",x1:"20%",y1:"0%",x2:"80%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"#FFFFFF"}),e.jsx("stop",{offset:"40%",stopColor:"rgba(186, 230, 253, 0.95)"}),e.jsx("stop",{offset:"100%",stopColor:"rgba(125, 211, 252, 0.7)"})]}),e.jsxs("linearGradient",{id:"cloudBorderGradAmber",x1:"20%",y1:"0%",x2:"80%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"#FFFFFF"}),e.jsx("stop",{offset:"45%",stopColor:"rgba(251, 191, 36, 0.95)"}),e.jsx("stop",{offset:"100%",stopColor:"rgba(245, 158, 11, 0.75)"})]}),e.jsxs("linearGradient",{id:"cloudBgGradDark",x1:"0%",y1:"0%",x2:"0%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"#1B2D4F"}),e.jsx("stop",{offset:"50%",stopColor:"#111D35"}),e.jsx("stop",{offset:"100%",stopColor:"#0A1224"})]}),e.jsxs("linearGradient",{id:"cloudBgGradDarkHover",x1:"0%",y1:"0%",x2:"0%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"#253D6B"}),e.jsx("stop",{offset:"50%",stopColor:"#172748"}),e.jsx("stop",{offset:"100%",stopColor:"#0E1931"})]}),e.jsxs("linearGradient",{id:"cloudBorderGradDark",x1:"20%",y1:"0%",x2:"80%",y2:"100%",children:[e.jsx("stop",{offset:"0%",stopColor:"rgba(125, 211, 252, 0.85)"}),e.jsx("stop",{offset:"45%",stopColor:"rgba(56, 189, 248, 0.65)"}),e.jsx("stop",{offset:"100%",stopColor:"rgba(129, 140, 248, 0.45)"})]})]})}),e.jsxs("div",{className:"container",children:[e.jsxs(A.div,{className:"section-head",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.7},children:[e.jsx("span",{className:"section-tag",children:"02 — Services"}),e.jsxs("h2",{className:"section-title",children:["What I ",e.jsx("span",{className:"gradient-text",children:"do best."})]})]}),e.jsx("div",{className:"services__grid",children:t.map((l,g)=>e.jsxs(A.article,{className:"service-card cursor-pointer",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.6,delay:g*.08},whileHover:{scale:1.03,y:-6},children:[e.jsx("svg",{className:"service-card__cloud-svg",viewBox:"0 0 400 260",preserveAspectRatio:"none","aria-hidden":"true",children:e.jsx("path",{className:"service-card__cloud-path",d:"M 140,50 C 155,18 245,18 260,50 C 295,45 345,60 345,95 C 375,110 395,135 385,160 C 385,195 360,235 325,235 C 285,242 240,242 200,238 C 160,242 115,242 75,235 C 40,235 15,195 15,160 C 5,135 25,110 55,95 C 55,60 105,45 140,50 Z"})}),e.jsxs("div",{className:"service-card__inner",children:[e.jsx("div",{className:"service-card__icon-box",children:e.jsx("i",{className:`${l.icon} service-card__icon`})}),e.jsx("h3",{children:l.title}),e.jsx("p",{children:l.desc})]})]},l.title))}),r&&e.jsx("div",{className:"flex justify-center mt-6",children:e.jsxs("button",{type:"button",className:"px-5 py-2.5 text-xs font-semibold rounded-full bg-sky-500/10 hover:bg-sky-500/20 text-sky-400 border border-sky-400/30 transition-all flex items-center gap-2 cursor-pointer shadow-sm hover:shadow-sky-500/20",onClick:()=>d(!0),children:[e.jsxs("span",{children:["عرض باقي الخدمات (+",ie.length-3,")"]}),e.jsx("i",{className:"fa-solid fa-chevron-down text-[10px]"})]})})]})]})}const bt=[{num:"01",icon:"fa-solid fa-lightbulb",title:"Idea",desc:"Every great piece starts with a spark — brainstorming concepts that align with your brand and audience."},{num:"02",icon:"fa-solid fa-chess-knight",title:"Strategy",desc:"Mapping the concept to platform, timing, format, and audience psychology for maximum impact."},{num:"03",icon:"fa-solid fa-pen-ruler",title:"Creation",desc:"Production — shooting, editing, designing. Where the idea becomes tangible, polished content."},{num:"04",icon:"fa-solid fa-paper-plane",title:"Publishing",desc:"Strategic release — timing, captions, hashtags, and distribution engineered for reach."},{num:"05",icon:"fa-solid fa-chart-line",title:"Results",desc:"Tracking, analyzing, and optimizing. Real numbers, real growth, real ROI."}],ft=[{num:"01",icon:"fa-solid fa-chess-knight",title:"Strategy",desc:"Mapping the concept to platform, timing, format, and audience psychology for maximum impact."},{num:"02",icon:"fa-solid fa-pen-ruler",title:"Creation",desc:"Production — shooting, editing, designing. Where the idea becomes tangible, polished content."},{num:"03",icon:"fa-solid fa-chart-line",title:"Results",desc:"Tracking, analyzing, and optimizing. Real numbers, real growth, real ROI."}];function yt(){const a=u.useRef(null),[i,o]=u.useState(0),[d,t]=u.useState(()=>typeof window<"u"?window.innerWidth<=768:!1);u.useEffect(()=>{const l=()=>{t(window.innerWidth<=768)};return window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[]),u.useEffect(()=>{const l=()=>{if(!a.current)return;const g=a.current.getBoundingClientRect(),m=window.innerHeight;if(g.top<=m*.75&&g.bottom>=m*.25){const n=Math.min(1,Math.max(0,(m*.75-g.top)/(g.height*.75)));o(n*100)}else g.top>m*.75?o(0):o(100)};return window.addEventListener("scroll",l,{passive:!0}),l(),()=>window.removeEventListener("scroll",l)},[]);const r=d?ft:bt;return e.jsx("section",{className:"section process",id:"process",children:e.jsxs("div",{className:"container",children:[e.jsxs(A.div,{className:"section-head",initial:{opacity:0,y:25},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.7},children:[e.jsx("span",{className:"section-tag",children:"03 — Process"}),e.jsxs("h2",{className:"section-title",children:["How the ",e.jsx("span",{className:"gradient-text",children:"magic"})," happens."]})]}),e.jsxs("div",{className:"process__track",id:"processTrack",ref:a,children:[e.jsxs("div",{className:"process__line",id:"processLine",children:[e.jsx("div",{className:"process__line-bg"}),e.jsx("div",{className:"process__line-fill transition-all duration-300 ease-out",id:"processLineFill",style:{width:d?"100%":`${i}%`,height:d?`${i}%`:"100%"}})]}),r.map((l,g)=>e.jsxs(A.div,{className:`process-step ${l.title==="Idea"?"process-step--idea":""} cursor-pointer`,"data-step":g+1,role:"button",tabIndex:0,initial:{opacity:0,y:20},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.5,delay:g*.1},whileHover:{scale:1.05,y:-4},children:[e.jsx("div",{className:"process-step__num",children:l.num}),e.jsxs("div",{className:"process-step__icon-wrap",children:[e.jsx("i",{className:l.icon}),e.jsx("span",{className:"process-step__ring"})]}),e.jsx("h3",{children:l.title}),e.jsx("p",{children:l.desc})]},l.title))]})]})})}function jt(){return e.jsx("section",{className:"section contact",id:"contact",children:e.jsx("div",{className:"container",children:e.jsxs(A.div,{className:"contact__center",initial:{opacity:0,y:30},whileInView:{opacity:1,y:0},viewport:{once:!0},transition:{duration:.8},children:[e.jsx("span",{className:"section-tag",children:"04 — Contact"}),e.jsxs("h2",{className:"section-title",children:["Let's create something ",e.jsx("span",{className:"gradient-text",children:"unforgettable."})]}),e.jsx("p",{className:"contact__text",children:"Have a project in mind? Let's talk. I work with brands and healthcare leaders who want to stand out — not blend in."}),e.jsxs("div",{className:"contact__info flex flex-wrap justify-center gap-4",children:[e.jsxs(A.a,{href:"mailto:shahdessam537@gmail.com",className:"contact-info group hover:border-sky-400/50 hover:bg-sky-500/10 transition-all",whileHover:{scale:1.04,y:-2},whileTap:{scale:.98},children:[e.jsx(Ue,{className:"w-5 h-5 text-sky-400 group-hover:scale-110 transition-transform"}),e.jsx("span",{children:"shahdessam537@gmail.com"})]}),e.jsxs(A.a,{href:"tel:+201092916162",className:"contact-info group hover:border-sky-400/50 hover:bg-sky-500/10 transition-all",whileHover:{scale:1.04,y:-2},whileTap:{scale:.98},children:[e.jsx(Me,{className:"w-5 h-5 text-emerald-400 group-hover:scale-110 transition-transform"}),e.jsx("span",{children:"+20 10 9291 6162"})]})]}),e.jsx("div",{className:"contact__socials mt-6",children:e.jsx(A.a,{href:"https://wa.me/201092916162",target:"_blank",rel:"noopener noreferrer",className:"contact-social","data-platform":"whatsapp","aria-label":"WhatsApp",whileHover:{scale:1.15,rotate:5},whileTap:{scale:.95},children:e.jsx("svg",{viewBox:"0 0 24 24",width:"22",height:"22",fill:"currentColor","aria-hidden":"true",children:e.jsx("path",{d:"M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.816 9.816 0 0 0 12.04 2zm.01 1.67c2.2 0 4.26.86 5.82 2.42a8.225 8.225 0 0 1 2.41 5.83c0 4.54-3.7 8.24-8.24 8.24-1.48 0-2.93-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.196 8.196 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.24-8.24zm4.52 11.66c-.25-.13-1.47-.72-1.7-.81-.23-.08-.39-.13-.56.13-.17.25-.64.81-.79.97-.14.17-.29.19-.54.06-.25-.13-1.06-.39-2.02-1.25-.75-.67-1.26-1.5-1.41-1.75-.15-.25-.02-.39.11-.51.11-.11.25-.29.37-.44.13-.15.17-.25.25-.42.08-.17.04-.31-.02-.44-.06-.13-.56-1.35-.77-1.85-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.44.06-.67.31-.23.25-.88.86-.88 2.1 0 1.24.9 2.44 1.03 2.61.13.17 1.77 2.71 4.3 3.8.6.26 1.07.41 1.44.53.61.19 1.16.17 1.6-.1.49-.3 1.47-1.2 1.68-1.66.21-.46.21-.86.15-.98-.06-.13-.23-.2-.48-.32z"})})})})]})})})}function vt(){const a=new Date().getFullYear();return e.jsx("footer",{className:"footer",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"footer__content",children:[e.jsxs("p",{className:"footer__copy",children:["© ",a," ",e.jsx("span",{className:"footer__brand-highlight",children:"shahd.ic"})," · All rights reserved."]}),e.jsxs("p",{className:"footer__dev",children:[e.jsx("span",{children:"Designed & Developed by"}),e.jsx("a",{href:"https://wa.me/201125296350",target:"_blank",rel:"noopener noreferrer",className:"footer__dev-link",title:"Chat with Mohamed Ahmed Ezzat on WhatsApp",children:e.jsx("span",{children:"Mohamed Ahmed Ezzat"})})]})]})})})}const ee={badr_reel1:{id:"badr_reel1",client:"بدر الشام · سوهاج",title:"تجهيز تورتة الشاورما 🎂",badge:"ريل 01",duration:"30 - 35 ثانية",hook:"خلاص.. زمن التورتة اللي بالكريمة انتهى! عيد ميلادك الجاي.. الشاورما هي البطل.",audio:"أول 3 ثواني: هدوء مع صوت نفخ الشمعة وصوت 'تشش' خفيف. بعد الـ Hook: تدخل مزيكا حماسية وسريعة (Hip-hop Beat أو Syrian Modern Beats). مع التركيز على مؤثرات الـ ASMR (صوت قرمشة العيش، صوت نزول الشاورما ع الطبق).",cta:"منشن لصاحبك اللي عيد ميلاده الشهر ده، وقوله الهدية وصلت!",scenes:[{num:"المشهد 01 | الـ Hook (إطفاء الشمعة)",visual:`الكاميرا بتبدأ قريبة جداً على شمعة منورة، فجأة الشيف بينفخ فيها يطفيها، والكاميرا بترجع لورا (Zoom out) بتبين إنه واقف ورا تورتة شاورما ضخمة وبيتكلم بثقة وحماس.
...
• الفكرة: تغطية أسبوعية متعمقة لمنطقة جغرافية واعدة في السوق المصري:
  ...
  - المحاور التحليلية الثابتة لكل منطقة:
    ...
    5. الشريحة المستهدفة ومن تناسبه هذه المنطقة تحديداً.`}]}},Y={categories:{medical:{id:"medical",path:"01_Medical_Sector.dir",name:"Healthcare & Medical Sector",nameAr:"القطاع الطبي والرعاية الصحية",icon:"fa-solid fa-stethoscope",accentColor:"#10B981",accentClass:"emerald",bgGlow:"rgba(16, 185, 129, 0.25)",tag:"01_HEALTHCARE_MEDICAL",shortDesc:"سلاسل جراحة التجميل، الوعي النفسي، رعاية الأم والطفل، وباقات الفحص الشامل.",folderCountLabel:"4 عملاء معتمدين",clients:[{id:"dr-omar",name:"د/ عمر أبو الدهب",subtitle:"جراحة التجميل والترميم ونحت القوام",category:"medical",icon:"fa-solid fa-user-doctor",tag:"جراحة التجميل والترميم",color:"#06B6D4",desc:"",deliverables:[{id:"omar_episodes",type:"approved_posts",title:"سلسلة نحت القوام (5 فيديوهات)",desc:"",badge:"5 فيديوهات"},{id:"omar_qa",type:"approved_posts",title:"أكتر أسئلة التجميل (10 مواضيع)",desc:"",badge:"10 مواضيع"},{id:"omar_month9",type:"approved_posts",title:"أفكار وبوستات شهر 9",desc:"",badge:"أفكار شهر 9"},{id:"omar_plan",type:"sheet_plan",title:"بلان محتوى شهر 9",desc:"",badge:"بلان شهر 9",sheetUrl:"https://docs.google.com/spreadsheets/d/1B7L69xjkMu3by2NZOMgtxxLVx5EW0u3TQB-gkgvZpH8/edit?gid=0#gid=0"}]},{id:"dr-maysa",name:"د/ مايسا",subtitle:"استشارات الوعي النفسي والعلاقات الإنسانية",category:"medical",icon:"fa-solid fa-heart-pulse",tag:"استشارات وعلاقات",color:"#14B8A6",desc:"",deliverables:[{id:"maysa_podcast",type:"episodes",title:"بودكاست الوعي النفسي والعلاقات (3 حلقات)",desc:"",badge:"بودكاست 3 حلقات"},{id:"maysa_month9",type:"approved_posts",title:"أفكار وبوستات شهر 9",desc:"",badge:"10 محاور معتمدة"},{id:"maysa_plan",type:"sheet_plan",title:"بلان شهري 8 و 9",desc:"",badge:"بلان شهرين",sheetUrl:"https://docs.google.com/spreadsheets/d/1prUaLHKUNTu_kfQjGAdemS_UAq-P_UVHkQ3DY7z-KiQ/edit?gid=0#gid=0"}]},{id:"al-nasr-pharmacy",name:"صيدلية النصر",subtitle:"رعاية صحية وتجميلية بإشراف د. أحمد العربي",category:"medical",icon:"fa-solid fa-prescription-bottle-medical",tag:"صيدلية وتجميل",color:"#10B981",desc:"",deliverables:[{id:"nasr_pharma_reels",type:"approved_posts",title:"ريلز بدائل الأدوية والكوزماتكس",desc:"",badge:"7 ريلز طبية"},{id:"nasr_mother_child",type:"approved_posts",title:"سلسلة الأم والطفل (5 ريلز)",desc:"",badge:"5 ريلز أمهات"},{id:"nasr_month9",type:"approved_posts",title:"أفكار وبوستات شهر 9",desc:"",badge:"أفكار وبوستات"},{id:"nasr_plan",type:"sheet_plan",title:"بلان شهري 8 و 9",desc:"",badge:"بلان شهرين",sheetUrl:"https://docs.google.com/spreadsheets/d/1gb9NtxIfeLvVv5x68zht6le6F0uddIMNCzzJNXwUW5w/edit?gid=0#gid=0"}]},{id:"al-raed-lab",name:"معمل الرائد",subtitle:"معامل الرائد للتحاليل الطبية والتشخيص المخبري",category:"medical",icon:"fa-solid fa-flask-vial",tag:"تحاليل طبية",color:"#3B82F6",desc:"",deliverables:[{id:"raed_plan",type:"sheet_plan",title:"باقات وعروض معمل الرائد",desc:"",badge:"باقات الفحص",sheetUrl:"https://docs.google.com/spreadsheets/d/1XwDE1QyTnVPC4dkfiAFBHH42ePxeFgw6diOuc6oSFUo/edit?gid=0#gid=0"}]}]},commercial:{id:"commercial",path:"02_Commercial_Retail.dir",name:"Commercial & Retail Sector",nameAr:"القطاع التجاري والتجزئة والأزياء",icon:"fa-solid fa-cart-shopping",accentColor:"#0EA5E9",accentClass:"cyan",bgGlow:"rgba(14, 165, 233, 0.25)",tag:"02_COMMERCIAL_RETAIL",shortDesc:"عروض الهايبر ماركت والمدارس، مهرجانات الصيف، ومجموعات الأزياء والعبايات الراقية.",folderCountLabel:"3 براندات معتمدة",clients:[{id:"hyper-elrehab",name:"هايبر الرحاب",subtitle:"هايبر ماركت وتجزئة ومستلزمات البيت",category:"commercial",icon:"fa-solid fa-basket-shopping",tag:"هايبر ماركت وتجزئة",color:"#0EA5E9",desc:"",deliverables:[{id:"rehab_posts",type:"approved_posts",title:"أفكار وبوستات عروض شهر 9",desc:"",badge:"عروض 12 قسماً"},{id:"rehab_plan",type:"sheet_plan",title:"بلان عروض ومحتوى شهر 9",desc:"",badge:"بلان شهر 9",sheetUrl:"https://docs.google.com/spreadsheets/d/10ujTHzbdoyQdkmVkRrUeenYRxZLMote6wP2DPzykQ9k/edit?gid=0#gid=0"}]},{id:"hyper-baraka",name:"هايبر بركه",subtitle:"سلسلة التجزئة والسوبرماركت والعروض الكبرى",category:"commercial",icon:"fa-solid fa-cart-flatbed",tag:"سلسلة تجزئة",color:"#38BDF8",desc:"",deliverables:[{id:"baraka_plan",type:"sheet_plan",title:"بلان عروض ومواسم هايبر بركه",desc:"",badge:"بلان 3 شهور",sheetUrl:"https://docs.google.com/spreadsheets/d/10BN3AZWixbe82V3NNDuu7xBG-AF9hWsn2t4gv4FFHRA/edit?gid=0#gid=0"}]},{id:"signorita",name:"سينيوريتا",subtitle:"أزياء نسائية فاخرة وعبايات خليجية راقية",category:"commercial",icon:"fa-solid fa-gem",tag:"أزياء وعبايات",color:"#EC4899",desc:"",deliverables:[{id:"signorita_reel",type:"script",title:"Reel 2 — عيد ميلادنا… وهداياه ليكي 🎁",desc:"",badge:"ريل المسابقة"},{id:"signorita_plan",type:"sheet_plan",title:"بلان محتوى سينيوريتا",desc:"",badge:"بلان المحتوى",sheetUrl:"https://docs.google.com/spreadsheets/d/1gnW8azZyWCAGtMajmAASn5qTMhR8lpaQDKqbSDkw6PY/edit?gid=0#gid=0"}]}]},food:{id:"food",path:"03_Food_Dining.dir",name:"Food & Dining Sector",nameAr:"قطاع المطاعم والأغذية والمشروبات",icon:"fa-solid fa-utensils",accentColor:"#F59E0B",accentClass:"amber",bgGlow:"rgba(245, 158, 11, 0.25)",tag:"03_FOOD_DINING",shortDesc:"ريلز الشاورما والبروستد، تحديات البرجر والشارع، العصائر الطبيعية والحلويات، ومحتوى الأكلات الشعبية.",folderCountLabel:"4 براندات معتمدة",clients:[{id:"badr-elsham",name:"بدر الشام · سوهاج",subtitle:"مأكولات سورية وشاورما ومشويات وبروستد",category:"food",icon:"fa-solid fa-bowl-food",tag:"مطاعم سورية",color:"#F59E0B",desc:"",deliverables:[{id:"badr_reel1",type:"script",title:"تجهيز تورتة الشاورما 🎂",desc:"",badge:"ريل 01"},{id:"badr_reel2",type:"script",title:"البروستد المقرمش 🍗",desc:"",badge:"ريل 02"},{id:"badr_reel3",type:"script",title:"التندوري السوري 🌶️",desc:"",badge:"ريل 03"},{id:"badr_reel4",type:"script",title:"فتة شاورما الفراخ (نسخة الـ 3 علامات) ⭐",desc:"",badge:"ريل 04"},{id:"badr_sheet1",type:"sheet_plan",title:"محتوى شهر 8 (18 بوست + 12 ريل)",desc:"",badge:"المحتوى المعتمد",sheetLinks:[{label:"18 بوست + 12 ريل شهر 8 (شهد)",url:"https://docs.google.com/spreadsheets/d/1H1WjuZfsbN592jRZjPwkthzUV0Y0_eWhfENJyMHPDPk/edit?gid=0#gid=0"},{label:"النسخة الأخيرة (بوستات) شهر 8",url:"https://docs.google.com/spreadsheets/d/1zRoRQMq9S_n1neToMF3vYWYFh3ZvX09Z3G9x8mbn-58/edit?gid=0#gid=0"}]},{id:"badr_sheet2",type:"sheet_plan",title:"بلان بدر الشام لشهر 8",desc:"",badge:"بلان شهر 8",sheetUrl:"https://docs.google.com/spreadsheets/d/1zRoRQMq9S_n1neToMF3vYWYFh3ZvX09Z3G9x8mbn-58/edit?gid=0#gid=0"},{id:"badr_trends",type:"trends_library",title:"بنك أفكار وتريندات الريلز (23 مرجع)",desc:"",badge:"23 تريند معتمد"}]},{id:"pold",name:"مطعم بولد · Pold",subtitle:"ساندوتشات وبرجر جورميه فاخر",category:"food",icon:"fa-solid fa-burger",tag:"برجر وساندوتشات",color:"#F97316",desc:"",deliverables:[{id:"pold_reel1",type:"script",title:"ريل آراء الناس في الشارع 🎤",desc:"",badge:"ريل 01"},{id:"pold_reel2",type:"script",title:"ريل رحلة الأوردر من المطبخ للعميل 🛵",desc:"",badge:"ريل 02"},{id:"pold_reel3",type:"script",title:"كواليس تجهيز الساندوتشات الجديدة 👨‍🍳",desc:"",badge:"ريل 03"},{id:"pold_reel4",type:"script",title:"مش كل اللي بيتقال عليه بولد… بولد 👑",desc:"",badge:"ريل 04"},{id:"pold_trends",type:"trends_library",title:"أفكار وتريندات ريلز بولد 🔥",desc:"",badge:"تريندات وسلوجانز"},{id:"pold_plan",type:"sheet_plan",title:"بلان محتوى مطعم بولد",desc:"",badge:"بلان المحتوى",sheetUrl:"https://docs.google.com/spreadsheets/d/1gY77SDdslAlTWySLk3HgdrPZNL-vQpZbZe7LWkc5FHo/edit?gid=0#gid=0"}]},{id:"koshary-sondos",name:"كشري سندس",subtitle:"طهطا · أكلات شعبية أصيلة",category:"food",icon:"fa-solid fa-bowl-rice",tag:"أكلات مصرية شعبية",color:"#EF4444",desc:"",deliverables:[{id:"sondos_posts",type:"approved_posts",title:"بوستات كشري سندس",desc:"",badge:"4 بوستات معتمدة"}]},{id:"elkhalat-pure",name:"الخلاط بيور طهطا",subtitle:"عصائر طبيعية 100% وحلويات وقعدة مريحة",category:"food",icon:"fa-solid fa-blender",tag:"عصائر طبيعية وحلويات",color:"#84CC16",desc:"",deliverables:[{id:"khalat_reel1",type:"script",title:"اسكريبت الريل الأول: ليه الخلاط وليه بالذات بيور",desc:"",badge:"ريل 01"},{id:"khalat_reel2",type:"script",title:"اسكريبت الريل الثاني: أنا عارف أنا عايز إيه",desc:"",badge:"ريل 02"},{id:"khalat_reel3",type:"script",title:"اسكريبت الريل الثالث: اختارلي حاجة على ذوقك",desc:"",badge:"ريل 03"},{id:"khalat_reel4",type:"script",title:"اسكريبت الريل الرابع: لو بتحب المانجا اسمع دي",desc:"",badge:"ريل 04"},{id:"khalat_reel5",type:"script",title:"اسكريبت الريل الخامس: عروض افتتاح الخلاط بيور",desc:"",badge:"ريل 05"},{id:"khalat_pdf_test",type:"script",title:"سكريبت ريل الخلاط (test)",desc:"",badge:"ريل تجريبي"},{id:"khalat_launch",type:"launch_plan",title:"Store Launch Plan 2 الخلاط",desc:"",badge:"خطة افتتاح"},{id:"khalat_august",type:"sheet_plan",title:"بلان الخلاط بيور شهر 8",desc:"",badge:"بلان شهر 8",sheetUrl:"https://docs.google.com/spreadsheets/d/1r2rpXAXBFQiT6Rk2L7R3-1KHP6TJ1ZmoPQ6tov6ynL4/edit?gid=0#gid=0"},{id:"khalat_pdf",type:"pdf_deck",title:"كامبين افتتاح الخلاط بيور",desc:"",badge:"ملف الكامبين"}]}]},realestate:{id:"realestate",path:"04_Brand_Strategy.dir",name:"Brand Strategy & Real Estate Sector",nameAr:"قطاع استراتيجية البراند والاستثمار العقاري",icon:"fa-solid fa-building-columns",accentColor:"#A855F7",accentClass:"purple",bgGlow:"rgba(168, 85, 247, 0.25)",tag:"04_STRATEGY_REALESTATE",shortDesc:"استراتيجيات بناء الهوية والعروض التقديمية، وسلاسل الاستشارات العقارية.",folderCountLabel:"ملف استراتيجي معتمد",clients:[{id:"shereen-samir",name:"أ/ شيرين سمير",subtitle:"مستشارة استثمار وتسويق عقاري",category:"realestate",icon:"fa-solid fa-building",tag:"استشارات عقارية",color:"#C084FC",desc:"",deliverables:[{id:"shereen_reels",type:"approved_posts",title:"12 سكريبت ريلز عقاري 🎬",desc:"",badge:"12 سكريبت"},{id:"shereen_month9",type:"approved_posts",title:"أفكار وبوستات شهر 9 🏢",desc:"",badge:"أفكار وبوستات"},{id:"shereen_plan",type:"sheet_plan",title:"بلان محتوى شهر 9 📊",desc:"",badge:"بلان شهر 9",sheetUrl:"https://docs.google.com/spreadsheets/d/12AD4HrJMEWcFwbARD2hzW91RwAynPJDxSIi_x--Kzhs/edit?gid=0#gid=0"}]}]}}};typeof window<"u"&&(window.SCRIPT_DATABASE=ee,window.WORK_HIERARCHY_DATA=Y);typeof oe<"u"&&oe.exports&&(oe.exports={SCRIPT_DATABASE:ee,WORK_HIERARCHY_DATA:Y});const J=a=>{if(!a)return[];if(a.sheetLinks&&a.sheetLinks.length>0)return a.sheetLinks;if(a.sheetUrl)return[{label:"Open in Google Sheets",url:a.sheetUrl}];const i=ee?ee[a.id]:null;return i!=null&&i.sheetLinks&&i.sheetLinks.length>0?i.sheetLinks:i!=null&&i.sheetUrl?[{label:"Open in Google Sheets",url:i.sheetUrl}]:[]},U=a=>a?a.type==="sheet_plan"||a.type==="xlsx"||!!a.sheetUrl||!!(a.sheetLinks&&a.sheetLinks.length>0)||J(a).length>0:!1,de=[{key:"medical",label:"Healthcare",labelAr:"القطاع الطبي",icon:"fa-solid fa-stethoscope",color:"#10B981"},{key:"commercial",label:"Commercial & Retail",labelAr:"العلامات التجارية",icon:"fa-solid fa-cart-shopping",color:"#0EA5E9"},{key:"food",label:"Food & Dining",labelAr:"المطاعم والأغذية",icon:"fa-solid fa-utensils",color:"#F59E0B"},{key:"realestate",label:"Brand Strategy",labelAr:"استراتيجية البراند",icon:"fa-solid fa-chess-knight",color:"#8B5CF6"}];function kt({isOpen:a,onClose:i,categoryKey:o="medical",onOpenDeliverable:d}){var ke,we,Ce;const[t,r]=u.useState(o),[l,g]=u.useState("folder"),[m,n]=u.useState(null),[f,v]=u.useState(!1),[S,w]=u.useState(""),[_,C]=u.useState("grid"),[B,R]=u.useState("all"),[T,O]=u.useState(()=>typeof window<"u"?window.innerWidth<=768:!1),[G,c]=u.useState(!1);u.useEffect(()=>{const s=()=>{O(window.innerWidth<=768)};return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[]),u.useEffect(()=>{o&&(r(o),g("folder"),n(null),w(""),R("all"),c(!1))},[o,a]),u.useEffect(()=>{const s=b=>{b.key==="Escape"&&a&&i()};return window.addEventListener("keydown",s),()=>window.removeEventListener("keydown",s)},[a,i]);const h=Y.categories[t]||Y.categories.medical,p=m?(ke=h.clients)==null?void 0:ke.find(s=>s.id===m):null,k=h.clients||[],x=T&&!G&&k.length>3?k.slice(0,3):k,F=T&&!G&&k.length>3,W=de.find(s=>s.key===t),z=(W==null?void 0:W.label)||h.name,V=(p==null?void 0:p.color)||h.accentColor||"#38BDF8",L=u.useMemo(()=>{if(!S.trim())return null;const s=S.trim().toLowerCase(),b=[];return Object.entries(Y.categories).forEach(([y,j])=>{var N;(N=j.clients)==null||N.forEach(E=>{const D=E.name.toLowerCase().includes(s)||E.tag.toLowerCase().includes(s)||E.subtitle&&E.subtitle.toLowerCase().includes(s),M=(E.deliverables||[]).filter(P=>P.title.toLowerCase().includes(s)||P.badge&&P.badge.toLowerCase().includes(s));(D||M.length>0)&&b.push({client:E,category:j,catKey:y,matchedDeliverables:M.length>0?M:E.deliverables||[]})})}),b},[S]),te=u.useMemo(()=>[{id:"script",label:"Reels",match:s=>s.type==="script"},{id:"sheet",label:"Plans",match:s=>U(s)||s.type==="sheet_plan"||s.type==="xlsx"},{id:"posts",label:"Posts",match:s=>s.type==="approved_posts"||s.type==="posts"||s.type==="post"},{id:"pdf",label:"Decks",match:s=>s.type==="pdf_deck"||s.type==="pdf"},{id:"episodes",label:"Podcasts",match:s=>s.type==="episodes"},{id:"launch_plan",label:"Launch Plans",match:s=>s.type==="launch_plan"},{id:"trends_library",label:"Trends",match:s=>s.type==="trends_library"}],[]),ne=u.useMemo(()=>{if(!p||!p.deliverables||p.deliverables.length===0)return[];const s=p.deliverables,b=te.filter(y=>s.some(j=>y.match(j)));return b.length<=1?[]:[{id:"all",label:"All",match:()=>!0},...b]},[p,te]);u.useEffect(()=>{B!=="all"&&(ne.some(b=>b.id===B)||R("all"))},[ne,B]);const H=u.useMemo(()=>{if(!p||!p.deliverables)return[];if(B==="all")return p.deliverables;const s=te.find(b=>b.id===B);return s?p.deliverables.filter(b=>s.match(b)):p.deliverables},[p,B,te]),re=(s,b)=>{b&&r(b),n(s.id),g("client"),w(""),R("all")},be=()=>{g("folder"),n(null),w(""),R("all")},fe=s=>{r(s),g("folder"),n(null),w(""),R("all")},ye=s=>s<=1?"grid grid-cols-1 max-w-xl mx-auto gap-3.5 sm:gap-4":s===2?"grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4":s===3?"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4":s===4?"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4":"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4",le=s=>{switch(s){case"script":return{label:"Video Script",color:"#F43F5E",icon:Fe,bg:"rgba(244, 63, 94, 0.14)"};case"sheet_plan":case"xlsx":return{label:"Content Plan",color:"#10B981",icon:I,bg:"rgba(16, 185, 129, 0.14)"};case"pdf_deck":case"pdf":return{label:"Presentation Deck",color:"#8B5CF6",icon:q,bg:"rgba(139, 92, 246, 0.14)"};case"approved_posts":return{label:"Approved Posts",color:"#0EA5E9",icon:Be,bg:"rgba(14, 165, 233, 0.14)"};case"episodes":return{label:"Podcast Series",color:"#EC4899",icon:pe,bg:"rgba(236, 72, 153, 0.14)"};case"launch_plan":return{label:"Launch Plan",color:"#F97316",icon:Je,bg:"rgba(249, 115, 22, 0.14)"};case"trends_library":return{label:"Trends Library",color:"#F59E0B",icon:K,bg:"rgba(245, 158, 11, 0.14)"};default:return{label:"Deliverable",color:"#38BDF8",icon:q,bg:"rgba(56, 189, 248, 0.14)"}}},je=u.useMemo(()=>{if(!H||H.length===0)return[];const s=[{key:"scripts",title:"اسكريبتات الفيديو الإعلانية (Video Scripts)",icon:Fe,color:"#F43F5E",badge:"Video Scripts",matcher:j=>j.type==="script"},{key:"plans",title:"خطط وجداول المحتوى الشهري (Content Plans & Calendars)",icon:I,color:"#10B981",badge:"Content Plans",matcher:j=>U(j)},{key:"episodes",title:"سلاسل البودكاست والفيديوهات (Podcast & Video Series)",icon:pe,color:"#EC4899",badge:"Podcast Series",matcher:j=>j.type==="episodes"},{key:"trends",title:"بنك الأفكار والتريندات المعتمدة (Trends & References)",icon:K,color:"#F59E0B",badge:"Trends Library",matcher:j=>j.type==="trends_library"},{key:"posts",title:"البوستات والمحتوى المعتمد (Approved Posts & Copy)",icon:Be,color:"#0EA5E9",badge:"Approved Posts",matcher:j=>j.type==="approved_posts"},{key:"decks",title:"العروض والاستراتيجيات (Presentations & Decks)",icon:q,color:"#8B5CF6",badge:"Strategy Decks",matcher:j=>j.type==="pdf_deck"||j.type==="pdf"},{key:"other",title:"مخرجات وملفات إضافية (Other Deliverables)",icon:q,color:"#38BDF8",badge:"Deliverable",matcher:()=>!0}],b=[],y=new Set;for(const j of s){const N=H.filter(E=>{const D=E.id||E.title;return y.has(D)?!1:j.matcher(E)});N.length>0&&(N.forEach(E=>y.add(E.id||E.title)),b.push({...j,items:N}))}return b},[H]),ve=(s,b,y="")=>{var P;const j=le(s.type),N=j.icon,E=U(s),D=E?J(s):[],M=(P=D[0])==null?void 0:P.url;return e.jsxs("div",{className:`bg-slate-900/50 hover:bg-slate-900/80 border ${E?"border-emerald-500/25 hover:border-emerald-400 hover:shadow-emerald-950/50":"border-white/10 hover:border-sky-500/40 hover:shadow-sky-950/40"} rounded-xl p-4 cursor-pointer transition-all flex flex-col justify-between group shadow-sm ${y}`,onClick:()=>{E&&M?window.open(M,"_blank","noopener,noreferrer"):d(s,p,h)},children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center justify-between mb-2.5",children:[e.jsxs("span",{className:"text-[10px] font-semibold px-2 py-0.5 rounded flex items-center gap-1",style:{background:j.bg,color:j.color},children:[e.jsx(N,{className:"w-3 h-3"}),e.jsx("span",{children:s.badge||j.label})]}),e.jsx("span",{className:"text-[10px] text-slate-500 font-medium",children:j.label})]}),e.jsxs("div",{className:"flex items-center gap-2.5 mb-2",children:[e.jsx("div",{className:"w-8 h-8 rounded-lg flex items-center justify-center text-sm shrink-0",style:{background:j.bg,color:j.color},children:e.jsx(N,{className:"w-4 h-4"})}),e.jsx("h4",{className:`text-sm font-bold text-white m-0 transition-colors leading-snug ${E?"group-hover:text-emerald-300":"group-hover:text-sky-300"}`,dir:"rtl",style:{textAlign:"right",width:"100%"},children:s.title})]})]}),e.jsx("div",{className:"pt-2.5 border-t border-white/5 flex items-center justify-between text-xs gap-2",children:E?D.length>1?e.jsx("div",{className:"flex items-center gap-1.5 w-full flex-wrap",children:D.map(($,X)=>e.jsxs("button",{type:"button",className:"text-[11px] font-bold text-white bg-emerald-600 hover:bg-emerald-500 border border-emerald-400/30 px-2 py-1.5 rounded-lg flex items-center gap-1 transition-all shadow-sm cursor-pointer flex-1 justify-center min-w-[110px]",onClick:Pe=>{Pe.stopPropagation(),window.open($.url,"_blank","noopener,noreferrer")},title:$.label,children:[e.jsx(I,{className:"w-3 h-3 text-emerald-200 shrink-0"}),e.jsx("span",{className:"truncate",children:$.label||`فتح شيت ${X+1} ↗`})]},X))}):e.jsxs("button",{type:"button",className:"w-full text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-500 border border-emerald-400/30 px-3 py-2 rounded-lg flex items-center justify-center gap-2 transition-all shadow-sm cursor-pointer",onClick:$=>{$.stopPropagation(),M&&window.open(M,"_blank","noopener,noreferrer")},title:"فتح في Google Sheets",children:[e.jsx(I,{className:"w-3.5 h-3.5 text-emerald-200"}),e.jsx("span",{children:"فتح في Google Sheets ↗"})]}):e.jsxs("span",{className:"text-sky-400 group-hover:text-sky-300 transition-colors flex items-center gap-1 font-medium ml-auto",children:[e.jsx("span",{children:"Details"}),e.jsx(Z,{className:"w-3 h-3"})]})})]},s.id||b)},He=(s,b)=>{var M;const y=le(s.type),j=y.icon,N=U(s),D=(M=(N?J(s):[])[0])==null?void 0:M.url;return e.jsxs("div",{className:`w-full bg-slate-900/60 hover:bg-slate-900/90 border ${N?"border-emerald-500/25 hover:border-emerald-400 hover:shadow-emerald-950/40":"border-white/12 hover:border-amber-500/40 hover:shadow-sky-950/40"} rounded-xl p-4 sm:p-5 cursor-pointer transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 group shadow-md`,onClick:()=>{N&&D?window.open(D,"_blank","noopener,noreferrer"):d(s,p,h)},children:[e.jsxs("div",{className:"flex items-center gap-3.5",dir:"rtl",style:{textAlign:"right"},children:[e.jsx("div",{className:"w-10 h-10 rounded-xl flex items-center justify-center text-lg shrink-0 shadow-inner",style:{background:y.bg,color:y.color},children:e.jsx(j,{className:"w-5 h-5"})}),e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-2 mb-1",children:[e.jsxs("span",{className:"text-[10px] font-semibold px-2 py-0.5 rounded flex items-center gap-1",style:{background:y.bg,color:y.color},children:[e.jsx(j,{className:"w-3 h-3"}),e.jsx("span",{children:s.badge||y.label})]}),e.jsx("span",{className:"text-[10px] text-slate-400 font-medium",children:N?"جدول معتمد مباشر":"مكتبة مرجعية معتمدة"})]}),e.jsx("h4",{className:`text-sm sm:text-base font-bold text-white m-0 transition-colors ${N?"group-hover:text-emerald-300":"group-hover:text-amber-300"}`,children:s.title})]})]}),e.jsx("div",{className:"flex items-center gap-2.5 shrink-0 self-end sm:self-center",children:N?e.jsxs("button",{type:"button",className:"text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-500 border border-emerald-400/30 px-3.5 py-2 rounded-lg flex items-center gap-2 transition-all shadow-sm cursor-pointer",onClick:P=>{P.stopPropagation(),D&&window.open(D,"_blank","noopener,noreferrer")},children:[e.jsx(I,{className:"w-3.5 h-3.5 text-emerald-200"}),e.jsx("span",{children:"فتح في Google Sheets ↗"})]}):e.jsxs("span",{className:"text-xs font-bold text-sky-400 group-hover:text-sky-300 transition-colors flex items-center gap-1.5 bg-sky-500/10 border border-sky-500/20 px-3 py-1.5 rounded-lg",children:[e.jsx("span",{children:"Details"}),e.jsx(Z,{className:"w-3.5 h-3.5"})]})})]},s.id||b)};return a?e.jsx(ge,{children:e.jsxs("div",{className:"finder-modal-overlay open",id:"finderModalOverlay",role:"dialog","aria-label":"Work Explorer","data-lenis-prevent":"true",children:[e.jsx(A.div,{className:"finder-modal-backdrop",id:"finderModalBackdrop",onClick:i,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0}}),e.jsx("div",{className:`finder-modal-dialog ${f?"finder-modal-dialog--fullscreen":""}`,"data-lenis-prevent":"true",children:e.jsxs(A.div,{className:"finder-window flex flex-col min-h-0 h-full",id:"finderWindow","data-lenis-prevent":"true",style:{"--sector-accent":V,...f?{width:"99vw",height:"96vh",maxWidth:"none"}:{}},initial:{opacity:0,scale:.96,y:15},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.96,y:15},transition:{type:"spring",damping:25,stiffness:320},children:[e.jsxs("div",{className:"finder-titlebar shrink-0 flex items-center justify-between px-3 sm:px-4 py-2 bg-slate-950/90 border-b border-white/10","data-lenis-prevent":"true",children:[e.jsx("div",{className:"flex items-center gap-2",children:e.jsxs("div",{className:"finder-traffic-lights",children:[e.jsx("button",{className:"t-btn t-btn--red",onClick:i,title:"Close"}),e.jsx("button",{className:"t-btn t-btn--yellow",onClick:i,title:"Minimize"}),e.jsx("button",{className:"t-btn t-btn--green",onClick:()=>v(!f),title:"Fullscreen"})]})}),e.jsx("div",{className:"flex-1 max-w-xs sm:max-w-sm mx-2 sm:mx-4",children:e.jsxs("div",{className:"relative flex items-center",children:[e.jsx(Ye,{className:"w-3.5 h-3.5 text-slate-400 absolute left-3 pointer-events-none"}),e.jsx("input",{type:"text",value:S,onChange:s=>w(s.target.value),placeholder:"Search work...",className:"w-full bg-slate-900/90 border border-white/10 rounded-lg py-1 pl-8 pr-7 text-xs text-white placeholder-slate-400 focus:outline-none focus:border-sky-400 transition-all text-left"}),S&&e.jsx("button",{onClick:()=>w(""),className:"absolute right-2.5 text-slate-400 hover:text-white",children:e.jsx(he,{className:"w-3 h-3"})})]})}),e.jsxs("div",{className:"flex items-center gap-1.5 sm:gap-2",children:[e.jsxs("div",{className:"hidden sm:flex items-center bg-slate-900 border border-white/10 rounded-md p-0.5",children:[e.jsx("button",{onClick:()=>C("grid"),className:`p-1 rounded text-xs transition-colors ${_==="grid"?"bg-sky-500/20 text-sky-300":"text-slate-400 hover:text-white"}`,title:"Grid",children:e.jsx(Ke,{className:"w-3.5 h-3.5"})}),e.jsx("button",{onClick:()=>C("list"),className:`p-1 rounded text-xs transition-colors ${_==="list"?"bg-sky-500/20 text-sky-300":"text-slate-400 hover:text-white"}`,title:"List",children:e.jsx(Xe,{className:"w-3.5 h-3.5"})})]}),e.jsx("button",{className:"w-7 h-7 rounded-md bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white flex items-center justify-center transition-colors",onClick:i,title:"Close",children:e.jsx(he,{className:"w-4 h-4"})})]})]}),e.jsxs("div",{className:"px-3 sm:px-5 py-2 bg-slate-950/60 border-b border-white/5 flex items-center justify-between text-xs text-slate-300 shrink-0","data-lenis-prevent":"true",children:[e.jsxs("div",{className:"flex items-center gap-1.5 sm:gap-2 truncate",children:[e.jsxs("button",{onClick:()=>{g("folder"),n(null),w("")},className:"hover:text-sky-300 transition-colors font-medium flex items-center gap-1.5 text-slate-400 shrink-0",children:[e.jsx(Qe,{className:"w-3.5 h-3.5 text-sky-400"}),e.jsx("span",{children:"Folders"})]}),e.jsx(Ae,{className:"w-3 h-3 text-slate-600 shrink-0"}),e.jsx("button",{onClick:be,className:`transition-colors font-medium truncate ${l==="folder"?"text-white":"text-slate-400 hover:text-white"}`,children:z}),l==="client"&&p&&e.jsxs(e.Fragment,{children:[e.jsx(Ae,{className:"w-3 h-3 text-slate-600 shrink-0"}),e.jsx("span",{className:"font-bold text-sky-300 truncate",dir:"rtl",children:p.name})]})]}),l==="client"&&e.jsxs("button",{onClick:be,className:"text-[11px] text-slate-400 hover:text-white flex items-center gap-1 transition-colors shrink-0 ml-2",children:[e.jsx(qe,{className:"w-3 h-3"}),e.jsx("span",{children:"Back"})]})]}),e.jsx("div",{className:"md:hidden flex items-center gap-1.5 px-3 py-2 bg-slate-950/90 border-b border-white/5 overflow-x-auto shrink-0","data-lenis-prevent":"true",style:{WebkitOverflowScrolling:"touch",scrollbarWidth:"none",msOverflowStyle:"none"},children:de.map(s=>{const b=t===s.key;return e.jsxs("button",{onClick:()=>fe(s.key),className:`px-2.5 py-1 rounded-md text-xs font-semibold whitespace-nowrap transition-all flex items-center gap-1.5 ${b?"bg-sky-500/20 text-white border border-sky-500/40 shadow-sm":"bg-white/5 text-slate-400 hover:text-white"}`,children:[e.jsx("i",{className:s.icon,style:{color:s.color,fontSize:"0.75rem"}}),e.jsx("span",{children:s.label})]},s.key)})}),e.jsxs("div",{className:"finder-body flex-1 min-h-0 h-full flex flex-col md:flex-row overflow-hidden","data-lenis-prevent":"true",children:[e.jsxs("aside",{className:"hidden md:flex w-52 bg-slate-950/80 border-r border-white/5 p-3 flex-col shrink-0 overflow-y-auto min-h-0","data-lenis-prevent":"true",style:{overflowY:"auto",WebkitOverflowScrolling:"touch",overscrollBehavior:"contain"},children:[e.jsx("div",{className:"text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2 px-2",children:"SECTORS"}),e.jsx("nav",{className:"space-y-1",children:de.map(s=>{var N;const b=t===s.key,y=Y.categories[s.key],j=((N=y==null?void 0:y.clients)==null?void 0:N.length)||0;return e.jsxs("button",{onClick:()=>fe(s.key),className:`w-full text-left px-2.5 py-2 rounded-lg text-xs font-semibold transition-all flex items-center justify-between ${b?"bg-sky-500/15 text-white border border-sky-500/30 shadow-sm":"text-slate-400 hover:bg-white/5 hover:text-slate-200 border border-transparent"}`,children:[e.jsxs("div",{className:"flex items-center gap-2 truncate",children:[e.jsx("i",{className:s.icon,style:{color:s.color}}),e.jsx("span",{className:"truncate",children:s.label})]}),e.jsx("span",{className:"text-[10px] text-slate-500 font-mono",children:j})]},s.key)})})]}),e.jsxs("main",{className:"finder-main-panel flex-1 min-h-0 h-full overflow-y-auto bg-slate-950/30 flex flex-col",id:"finderMainPanel","data-lenis-prevent":"true",style:{overflowY:"auto",WebkitOverflowScrolling:"touch",overscrollBehavior:"contain"},children:[!S&&e.jsxs("div",{className:"p-3.5 sm:p-5 border-b border-white/5 shrink-0",children:[e.jsx("div",{className:"flex items-center justify-between",children:e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-[10px] font-semibold px-2 py-0.5 rounded uppercase tracking-wider",style:{background:`${V}18`,color:V},children:l==="client"?p==null?void 0:p.tag:h.tag}),e.jsx("span",{className:"text-xs text-slate-400",children:l==="client"?`${((we=p==null?void 0:p.deliverables)==null?void 0:we.length)||0} Deliverables`:`${((Ce=h.clients)==null?void 0:Ce.length)||0} Clients`})]}),e.jsx("h3",{className:"text-base sm:text-lg font-bold text-white mt-1 mb-0",dir:l==="client"?"rtl":"ltr",children:l==="client"?p==null?void 0:p.name:z})]})}),l==="client"&&ne.length>1&&e.jsx("div",{className:"flex items-center gap-1.5 mt-3 pt-2.5 border-t border-white/5 overflow-x-auto",style:{WebkitOverflowScrolling:"touch",scrollbarWidth:"none",msOverflowStyle:"none"},children:ne.map(s=>{const b=s.id==="all"?p.deliverables.length:p.deliverables.filter(y=>s.match(y)).length;return e.jsxs("button",{onClick:()=>R(s.id),className:`px-3 py-1 rounded-lg text-xs font-semibold transition-all whitespace-nowrap flex items-center gap-1.5 cursor-pointer ${B===s.id?"bg-sky-500/20 text-sky-300 font-bold border border-sky-400/35 shadow-sm":"bg-white/5 text-slate-400 hover:text-white hover:bg-white/10 border border-transparent"}`,children:[e.jsx("span",{children:s.label}),e.jsx("span",{className:`text-[10px] px-1.5 py-0.5 rounded-full ${B===s.id?"bg-sky-400/25 text-sky-200":"bg-white/10 text-slate-400"}`,children:b})]},s.id)})})]}),e.jsx("div",{className:"p-3.5 sm:p-5 pb-20 flex-1","data-lenis-prevent":"true",children:S&&L?e.jsxs("div",{children:[e.jsxs("div",{className:"text-xs text-slate-400 mb-3",children:["Search Results (",L.length,"):"]}),L.length===0?e.jsx("div",{className:"text-center py-12 text-slate-500 text-xs",children:"No matching results found"}):e.jsx("div",{className:ye(L.length),children:L.map(({client:s,category:b,catKey:y,matchedDeliverables:j},N)=>e.jsxs("div",{className:"bg-slate-900/50 border border-white/10 rounded-xl p-3.5 hover:border-sky-500/40 transition-colors flex flex-col justify-between",children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsxs("div",{dir:"rtl",className:"text-right",children:[e.jsx("h4",{className:"text-white font-bold text-sm",children:s.name}),e.jsx("span",{className:"text-[11px] text-slate-400",children:b.name})]}),e.jsxs("button",{onClick:()=>re(s,y),className:"text-xs text-sky-400 hover:text-sky-300 font-medium flex items-center gap-1",children:[e.jsx("span",{children:"Open"}),e.jsx(Z,{className:"w-3 h-3"})]})]}),e.jsx("div",{className:"flex flex-wrap gap-1.5 pt-2 border-t border-white/5",dir:"rtl",children:j.map((E,D)=>{var X;const M=U(E),$=(X=(M?J(E):[])[0])==null?void 0:X.url;return e.jsxs("button",{onClick:()=>{M&&$?window.open($,"_blank","noopener,noreferrer"):d(E,s,b)},className:`text-xs px-2.5 py-1 rounded transition-colors text-right truncate max-w-[220px] flex items-center gap-1.5 ${M?"bg-emerald-500/15 hover:bg-emerald-600 text-emerald-300 hover:text-white border border-emerald-500/30 font-bold":"bg-white/5 hover:bg-sky-500/20 text-slate-300 hover:text-white"}`,title:M?"فتح في Google Sheets":E.title,children:[M&&e.jsx(I,{className:"w-3 h-3 text-emerald-400 shrink-0"}),e.jsx("span",{className:"truncate",children:E.title})]},D)})})]},N))})]}):l==="folder"?_==="grid"?e.jsxs("div",{children:[e.jsx("div",{className:ye(x.length),children:x.map((s,b)=>{const y=s.color||V,j=s.deliverables?s.deliverables.length:0;return e.jsxs("div",{className:"bg-slate-900/50 hover:bg-slate-900/80 border border-white/10 hover:border-sky-500/40 rounded-xl p-4 cursor-pointer transition-all flex flex-col justify-between group",onClick:()=>re(s),children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center justify-between mb-3",children:[e.jsx("span",{className:"text-[10px] font-semibold px-2 py-0.5 rounded",style:{background:`${y}18`,color:y},children:s.tag}),e.jsxs("span",{className:"text-[11px] text-slate-400 font-mono",children:[j," Files"]})]}),e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx("div",{className:"w-10 h-10 rounded-xl flex items-center justify-center text-base shrink-0 transition-transform group-hover:scale-105",style:{background:`${y}20`,color:y},children:e.jsx("i",{className:s.icon||"fa-solid fa-folder"})}),e.jsxs("div",{className:"min-w-0",dir:"rtl",style:{textAlign:"right",width:"100%"},children:[e.jsx("h4",{className:"text-sm font-bold text-white m-0 truncate group-hover:text-sky-300 transition-colors",children:s.name}),e.jsx("p",{className:"text-xs text-slate-400 m-0 truncate",children:s.subtitle||s.tag})]})]})]}),e.jsx("div",{className:"pt-2.5 border-t border-white/5 flex items-center justify-end text-xs text-sky-400 group-hover:text-sky-300 transition-colors",children:e.jsxs("span",{className:"flex items-center gap-1 font-medium",children:[e.jsx("span",{children:"Explore"}),e.jsx(Z,{className:"w-3 h-3"})]})})]},s.id||b)})}),F&&e.jsx("div",{className:"flex justify-center mt-4",children:e.jsxs("button",{type:"button",className:"px-4 py-2 text-xs font-semibold rounded-lg bg-sky-500/10 hover:bg-sky-500/20 text-sky-300 border border-sky-500/30 transition-all flex items-center gap-2",onClick:()=>c(!0),children:[e.jsxs("span",{children:["عرض باقي الحسابات (+",k.length-3,")"]}),e.jsx(Z,{className:"w-3.5 h-3.5"})]})})]}):e.jsxs("div",{children:[e.jsx("div",{className:"bg-slate-900/40 border border-white/10 rounded-xl overflow-hidden",children:e.jsxs("table",{className:"w-full text-left text-xs",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"bg-slate-900/80 text-slate-400 border-b border-white/5 font-semibold",children:[e.jsx("th",{className:"p-3",children:"Client"}),e.jsx("th",{className:"p-3",children:"Category"}),e.jsx("th",{className:"p-3",children:"Files"}),e.jsx("th",{className:"p-3 text-right",children:"Action"})]})}),e.jsx("tbody",{className:"divide-y divide-white/5",children:x.map((s,b)=>{var y;return e.jsxs("tr",{className:"hover:bg-sky-500/10 transition-colors cursor-pointer",onClick:()=>re(s),children:[e.jsxs("td",{className:"p-3 font-semibold text-white flex items-center gap-2",dir:"rtl",children:[e.jsx("span",{style:{color:s.color||V},children:e.jsx("i",{className:s.icon||"fa-solid fa-folder"})}),e.jsx("span",{children:s.name})]}),e.jsx("td",{className:"p-3 text-slate-400",children:s.tag}),e.jsx("td",{className:"p-3 text-slate-500 font-mono",children:((y=s.deliverables)==null?void 0:y.length)||0}),e.jsx("td",{className:"p-3 text-right",children:e.jsx("span",{className:"text-sky-400 hover:underline",children:"Open"})})]},b)})})]})}),F&&e.jsx("div",{className:"flex justify-center mt-4",children:e.jsxs("button",{type:"button",className:"px-4 py-2 text-xs font-semibold rounded-lg bg-sky-500/10 hover:bg-sky-500/20 text-sky-300 border border-sky-500/30 transition-all flex items-center gap-2",onClick:()=>c(!0),children:[e.jsxs("span",{children:["عرض باقي الحسابات (+",k.length-3,")"]}),e.jsx(Z,{className:"w-3.5 h-3.5"})]})})]}):_==="grid"?je.length>1?e.jsx("div",{className:"space-y-6",children:je.map(s=>{const b=s.items.length,y=s.icon;return e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"flex items-center justify-between pb-2 border-b border-white/5",dir:"rtl",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"w-6 h-6 rounded-md flex items-center justify-center text-xs",style:{background:`${s.color}22`,color:s.color},children:e.jsx(y,{className:"w-3.5 h-3.5"})}),e.jsx("h4",{className:"text-xs font-bold text-slate-200 tracking-wide m-0",children:s.title})]}),e.jsxs("span",{className:"text-[10px] font-mono px-2 py-0.5 rounded-full bg-white/5 text-slate-400 font-semibold",children:[b," ",b===1?"ملف":"ملفات"]})]}),b===1?He(s.items[0],0):e.jsx("div",{className:b===2?"grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4":b===3?"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4":b===4?"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4":"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4",children:s.items.map((j,N)=>ve(j,N))})]},s.key)})}):e.jsx("div",{className:H.length===1?"grid grid-cols-1 max-w-xl mx-auto gap-3.5 sm:gap-4":H.length===2?"grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4":H.length===3?"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4":H.length===4?"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4":"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 sm:gap-4",children:H.map((s,b)=>{const y=H.length%3===1&&b===H.length-1;return ve(s,b,y?"sm:col-span-2 lg:col-span-3":"")})}):e.jsx("div",{className:"bg-slate-900/40 border border-white/10 rounded-xl overflow-x-auto",style:{WebkitOverflowScrolling:"touch"},children:e.jsxs("table",{className:"w-full text-left text-xs min-w-[500px]",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"bg-slate-900/80 text-slate-400 border-b border-white/5 font-semibold",children:[e.jsx("th",{className:"p-3",children:"Deliverable"}),e.jsx("th",{className:"p-3",children:"Type"}),e.jsx("th",{className:"p-3",children:"Tag"}),e.jsx("th",{className:"p-3 text-right",children:"Action"})]})}),e.jsx("tbody",{className:"divide-y divide-white/5",children:H.map((s,b)=>{var M;const y=le(s.type),j=y.icon,N=U(s),D=(M=(N?J(s):[])[0])==null?void 0:M.url;return e.jsxs("tr",{className:`transition-colors cursor-pointer ${N?"hover:bg-emerald-500/10":"hover:bg-sky-500/10"}`,onClick:()=>{N&&D?window.open(D,"_blank","noopener,noreferrer"):d(s,p,h)},children:[e.jsxs("td",{className:"p-3 font-semibold text-white flex items-center gap-2",dir:"rtl",children:[e.jsx(j,{className:"w-3.5 h-3.5 shrink-0",style:{color:N?"#10B981":y.color}}),e.jsx("span",{children:s.title})]}),e.jsx("td",{className:"p-3 text-slate-400",children:N?"Google Sheets":y.label}),e.jsx("td",{className:"p-3",children:e.jsx("span",{className:"text-[10px] px-1.5 py-0.5 rounded font-mono",style:{background:N?"rgba(16, 185, 129, 0.15)":y.bg,color:N?"#34D399":y.color},children:s.badge||"Document"})}),e.jsx("td",{className:"p-3 text-right",children:N?e.jsxs("button",{type:"button",className:"text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-500 border border-emerald-400/30 px-2.5 py-1 rounded-md inline-flex items-center gap-1 cursor-pointer transition-all shadow-sm",onClick:P=>{P.stopPropagation(),D&&window.open(D,"_blank","noopener,noreferrer")},children:[e.jsx(I,{className:"w-3 h-3 text-emerald-100"}),e.jsx("span",{children:"فتح الشيت ↗"})]}):e.jsx("span",{className:"text-sky-400 hover:underline font-medium",children:"View Details"})})]},b)})})]})})})]})]})]})})]})}):null}function wt(a){if(!a)return"empty";const i=a.trim();return/الفكرة العامة/i.test(i)||/المشهد التمثيلي/i.test(i)||/محاور الحوار/i.test(i)||/للمصور والمونتير/i.test(i)||/بودكاست/i.test(i)&&(/الانترو/i.test(i)||/النهاية/i.test(i))?"podcast":/(^|\n)[ \t]*(hook|intro|body|conclusion|conclusion line|end\s*line|cta|editor|for editor|الهوك|المقدمة|صلب الموضوع|الخاتمة)[ \t]*(:|\n|$)/i.test(i)?"reel":/(^|\n)\s*\d+[\.\-\)]\s*["\u0600-\u06FFa-zA-Z]/.test(i)?"post_ideas":"general"}const Ct=[{key:"concept",match:/^(الفكرة العامة|فكرة الحلقة):?/i,title:"الفكرة العامة للحلقة"},{key:"dramaticScene",match:/^(المشهد التمثيلي|مشهد تمثيلي|مشهد البداية)/i,title:"المشهد التمثيلي الافتتاحي"},{key:"directorNotes",match:/^(للمصور والمونتير|ملاحظات المخرج والمونتير|توجيهات التصوير والمونتاج):?/i,title:"توجيهات التصوير والمونتاج"},{key:"intro",match:/^(الانترو|المقدمة|انترو الحلقة):?/i,title:"انترو البودكاست وبداية الحوار"},{key:"discussionPillars",match:/^(محاور الحوار|أثناء الحوار|محاور النقاش|الأسئلة):?/i,title:"محاور وأسئلة النقاش الأساسية"},{key:"ending",match:/^(النهاية|خاتمة الحلقة|الختام):?/i,title:"ختام الحلقة والرسالة الجوهرية"},{key:"interactiveCta",match:/^(CTA التفاعلي|الدعوة التفاعلية|سؤال التفاعل):?/i,title:"سؤال التفاعل والكومنتات"},{key:"commercialCta",match:/^(CTA البيعي|CTA التجاري|الدعوة للعمل|الدعوة التجارية):?/i,title:"الدعوة للاستشارة وحجز الجلسات"}];function St(a){const i=a.split(`
`).map(t=>t.trim()).filter(Boolean),o={title:"",sections:[]};let d=null;for(let t=0;t<i.length;t++){const r=i[t],l=Ct.find(g=>g.match.test(r));if(l){d={key:l.key,title:r,lines:[]},o.sections.push(d);continue}d?d.lines.push(r):!o.title&&(r.includes("بودكاست")||r.includes("حلقة"))&&(o.title=r)}return o}function Nt({scriptText:a}){const i=St(a);return e.jsxs("div",{className:"space-y-4",dir:"rtl",style:{textAlign:"right"},children:[i.title&&e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(236, 72, 153, 0.16), rgba(168, 85, 247, 0.08))",border:"1.5px solid rgba(236, 72, 153, 0.35)",borderRadius:"14px",padding:"14px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"10px",boxShadow:"0 4px 20px rgba(236, 72, 153, 0.12)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px"},children:[e.jsx("div",{style:{width:"36px",height:"36px",borderRadius:"10px",background:"rgba(236, 72, 153, 0.22)",display:"flex",alignItems:"center",justifyContent:"center",color:"#F472B6"},children:e.jsx(pe,{className:"w-5 h-5"})}),e.jsx("h4",{style:{margin:0,color:"#FFFFFF",fontSize:"1.1rem",fontWeight:800},children:i.title})]}),e.jsx("span",{style:{fontSize:"0.76rem",fontWeight:800,color:"#F472B6",background:"rgba(236, 72, 153, 0.15)",border:"1px solid rgba(236, 72, 153, 0.3)",padding:"3px 10px",borderRadius:"6px"},children:"سكريبت حلقة بودكاست تفصيلي"})]}),i.sections.map((o,d)=>{if(o.key==="concept")return e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(245, 158, 11, 0.12), rgba(217, 119, 6, 0.04))",border:"1.5px solid rgba(245, 158, 11, 0.3)",borderRadius:"14px",padding:"16px 20px",boxShadow:"0 4px 16px rgba(245, 158, 11, 0.08)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"8px"},children:[e.jsx(ue,{className:"w-4 h-4 text-amber-400"}),e.jsx("span",{style:{color:"#FBBF24",fontSize:"0.82rem",fontWeight:800},children:"الفكرة العامة للحلقة (Core Concept)"})]}),e.jsx("p",{style:{margin:0,color:"#FEF9C3",fontSize:"1.02rem",fontWeight:600,lineHeight:1.85},children:o.lines.join(" ")})]},d);if(o.key==="dramaticScene")return e.jsxs("div",{style:{background:"rgba(15, 23, 42, 0.85)",border:"1.5px solid rgba(99, 102, 241, 0.28)",borderRadius:"14px",padding:"18px 20px",boxShadow:"0 8px 24px rgba(0, 0, 0, 0.3)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"14px",flexWrap:"wrap",gap:"8px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[e.jsx(nt,{className:"w-4 h-4 text-indigo-400"}),e.jsx("span",{style:{color:"#A5B4FC",fontSize:"0.84rem",fontWeight:800},children:o.title||"المشهد التمثيلي الافتتاحي"})]}),e.jsx("span",{style:{fontSize:"0.74rem",color:"#CBD5E1",background:"rgba(99, 102, 241, 0.15)",border:"1px solid rgba(99, 102, 241, 0.3)",padding:"2px 8px",borderRadius:"6px"},children:"⏱️ 20–30 ثانية تمثيل واقعي"})]}),e.jsx("div",{className:"space-y-2.5",children:o.lines.map((t,r)=>{const l=/^المشهد:/i.test(t),g=/^آخر لقطة:/i.test(t),m=/^Cut\.?$/i.test(t.trim()),n=/^["«]/i.test(t)||/["»]$/i.test(t),f=/(هي تسأله|يرد|تسكت|بعدها تلاحظ|المهم:)/i.test(t);return l?e.jsxs("div",{style:{background:"rgba(99, 102, 241, 0.12)",border:"1px solid rgba(99, 102, 241, 0.25)",borderRadius:"8px",padding:"8px 12px",color:"#E0E7FF",fontSize:"0.9rem",fontWeight:700,display:"flex",alignItems:"center",gap:"6px"},children:[e.jsx(me,{className:"w-3.5 h-3.5 text-indigo-400 shrink-0"}),e.jsx("span",{children:t})]},r):m?e.jsx("div",{style:{display:"flex",justifyContent:"center",margin:"10px 0"},children:e.jsx("span",{style:{background:"rgba(239, 68, 68, 0.15)",border:"1px solid rgba(239, 68, 68, 0.35)",color:"#FCA5A5",fontWeight:800,fontSize:"0.76rem",padding:"4px 14px",borderRadius:"20px",display:"inline-flex",alignItems:"center",gap:"6px"},children:"🎬 Cut مفاجئ إلى د. مايسا وزوجها بالأستوديو"})},r):g?e.jsxs("div",{style:{background:"rgba(245, 158, 11, 0.08)",border:"1px dashed rgba(245, 158, 11, 0.3)",borderRadius:"8px",padding:"10px 14px",color:"#FDE68A",fontSize:"0.9rem",fontWeight:650},children:[e.jsx("span",{style:{color:"#F59E0B",fontWeight:800,display:"block",marginBottom:"2px",fontSize:"0.76rem"},children:"📸 توجيه اللقطة الختامية:"}),t.replace(/^آخر لقطة:?/i,"").trim()]},r):n?e.jsx("div",{style:{margin:"6px 0 6px 20px",background:"linear-gradient(135deg, rgba(236, 72, 153, 0.14), rgba(168, 85, 247, 0.08))",borderRight:"3px solid #EC4899",borderRadius:"8px",padding:"8px 14px",color:"#FFFFFF",fontSize:"0.98rem",fontWeight:750,display:"inline-block",boxShadow:"0 2px 8px rgba(0,0,0,0.2)"},children:t},r):f?e.jsx("p",{style:{margin:"6px 0 2px 0",color:"#94A3B8",fontSize:"0.88rem",fontWeight:600},children:t},r):e.jsx("p",{style:{margin:"4px 0",color:"#CBD5E1",fontSize:"0.94rem",lineHeight:1.75},children:t},r)})})]},d);if(o.key==="directorNotes")return e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(30, 41, 59, 0.85), rgba(15, 23, 42, 0.95))",border:"1.5px dashed rgba(56, 189, 248, 0.35)",borderRadius:"14px",padding:"16px 20px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"12px"},children:[e.jsx(De,{className:"w-4 h-4 text-sky-400"}),e.jsx("span",{style:{color:"#38BDF8",fontSize:"0.82rem",fontWeight:800},children:"🎥 توجيهات المخرج والمونتير (Director & Camera Brief)"})]}),e.jsx("div",{className:"space-y-2",children:o.lines.map((t,r)=>e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"8px",background:"rgba(255, 255, 255, 0.025)",border:"1px solid rgba(255, 255, 255, 0.05)",borderRadius:"8px",padding:"8px 12px"},children:[e.jsx("span",{style:{color:"#38BDF8",fontWeight:800,fontSize:"0.8rem",marginTop:"2px"},children:"•"}),e.jsx("span",{style:{color:"#E2E8F0",fontSize:"0.9rem",lineHeight:1.65},children:t})]},r))})]},d);if(o.key==="intro")return e.jsxs("div",{style:{background:"rgba(14, 165, 233, 0.07)",border:"1.5px solid rgba(56, 189, 248, 0.28)",borderRadius:"14px",padding:"18px 20px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"14px"},children:[e.jsx(Te,{className:"w-4 h-4 text-sky-400"}),e.jsx("span",{style:{color:"#38BDF8",fontSize:"0.82rem",fontWeight:800},children:"🎙️ انترو البودكاست وبداية الحوار (Intro & Dialogue Hook)"})]}),e.jsx("div",{className:"space-y-2.5",children:o.lines.map((t,r)=>{const l=/^(د\.\s*مايسا|مايسا):/i.test(t),g=/^(الزوج|جوزها):/i.test(t),m=/^(ثم|بعد المشهد|وبعدها):/i.test(t);return l?e.jsxs("div",{style:{background:"rgba(236, 72, 153, 0.09)",border:"1px solid rgba(236, 72, 153, 0.25)",borderRadius:"10px",padding:"10px 14px"},children:[e.jsx("span",{style:{color:"#F472B6",fontSize:"0.78rem",fontWeight:800,display:"block",marginBottom:"4px"},children:"🎙️ د. مايسا (Host):"}),e.jsx("p",{style:{margin:0,color:"#FFFFFF",fontSize:"0.98rem",fontWeight:650,lineHeight:1.8},children:t.replace(/^(د\.\s*مايسا|مايسا):?/i,"").trim()})]},r):g?e.jsxs("div",{style:{background:"rgba(56, 189, 248, 0.09)",border:"1px solid rgba(56, 189, 248, 0.25)",borderRadius:"10px",padding:"10px 14px"},children:[e.jsx("span",{style:{color:"#38BDF8",fontSize:"0.78rem",fontWeight:800,display:"block",marginBottom:"4px"},children:"🎙️ الزوج (Co-Host):"}),e.jsx("p",{style:{margin:0,color:"#F0F9FF",fontSize:"0.98rem",fontWeight:650,lineHeight:1.8},children:t.replace(/^(الزوج|جوزها):?/i,"").trim()})]},r):m?e.jsx("div",{style:{color:"#94A3B8",fontSize:"0.84rem",fontWeight:600,padding:"2px 6px"},children:t},r):e.jsx("p",{style:{margin:"4px 0",color:"#E2E8F0",fontSize:"0.94rem",lineHeight:1.75},children:t},r)})})]},d);if(o.key==="discussionPillars"){const t=[],r=[],l=[];let g=!1;return o.lines.forEach(m=>{/^(مهم جدًا|ملاحظة هامة|توجيه):?/i.test(m)&&(g=!0),g?l.push(m):/(\?|؟)$/.test(m.trim())||r.length>0?r.push(m):t.push(m)}),e.jsxs("div",{style:{background:"rgba(15, 23, 42, 0.75)",border:"1.5px solid rgba(168, 85, 247, 0.3)",borderRadius:"14px",padding:"18px 20px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"14px",flexWrap:"wrap",gap:"8px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[e.jsx(st,{className:"w-4 h-4 text-purple-400"}),e.jsx("span",{style:{color:"#C084FC",fontSize:"0.84rem",fontWeight:800},children:"💬 محاور وأسئلة النقاش الأساسية (Discussion Pillars)"})]}),r.length>0&&e.jsxs("span",{style:{fontSize:"0.74rem",color:"#C084FC",background:"rgba(168, 85, 247, 0.15)",border:"1px solid rgba(168, 85, 247, 0.3)",padding:"2px 8px",borderRadius:"6px",fontWeight:700},children:[r.length," محاور للنقاش"]})]}),t.length>0&&e.jsx("div",{style:{color:"#94A3B8",fontSize:"0.86rem",marginBottom:"12px",fontStyle:"italic"},children:t.join(" ")}),e.jsx("div",{className:"space-y-2.5",children:r.map((m,n)=>e.jsxs("div",{style:{background:"rgba(255, 255, 255, 0.03)",border:"1px solid rgba(255, 255, 255, 0.07)",borderRadius:"10px",padding:"12px 16px",display:"flex",alignItems:"flex-start",gap:"12px",transition:"all 0.2s ease"},className:"hover:border-purple-500/40 hover:bg-white/5",children:[e.jsxs("span",{style:{background:"rgba(168, 85, 247, 0.18)",color:"#D8B4FE",fontWeight:800,fontSize:"0.74rem",padding:"3px 9px",borderRadius:"6px",flexShrink:0,marginTop:"2px",whiteSpace:"nowrap"},children:["محور ",n+1]}),e.jsx("p",{style:{margin:0,color:"#F1F5F9",fontSize:"0.94rem",fontWeight:600,lineHeight:1.7,flex:1},children:m})]},n))}),l.length>0&&e.jsxs("div",{style:{marginTop:"14px",background:"linear-gradient(135deg, rgba(245, 158, 11, 0.12), rgba(217, 119, 6, 0.04))",border:"1px solid rgba(245, 158, 11, 0.3)",borderRadius:"10px",padding:"12px 16px"},children:[e.jsxs("span",{style:{color:"#FBBF24",fontSize:"0.78rem",fontWeight:800,display:"flex",alignItems:"center",gap:"6px",marginBottom:"4px"},children:[e.jsx(K,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"توجيه حواري حاسم لإثارة التفاعل:"})]}),e.jsx("p",{style:{margin:0,color:"#FEF9C3",fontSize:"0.9rem",lineHeight:1.7},children:l.join(" ").replace(/^(مهم جدًا:?)/i,"").trim()})]})]},d)}return o.key==="ending"?e.jsxs("div",{style:{background:"rgba(168, 85, 247, 0.08)",border:"1.5px solid rgba(168, 85, 247, 0.28)",borderRadius:"14px",padding:"18px 20px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"12px"},children:[e.jsx(it,{className:"w-4 h-4 text-purple-400"}),e.jsx("span",{style:{color:"#C084FC",fontSize:"0.82rem",fontWeight:800},children:"✨ ختام الحلقة والرسالة الجوهرية (The Ending)"})]}),e.jsx("div",{className:"space-y-2.5",children:o.lines.map((t,r)=>{const l=/^(د\.\s*مايسا|مايسا):/i.test(t),g=/^(الزوج|جوزها):/i.test(t),m=/(تنظر للكاميرا|ثم تنظر|ثم:)/i.test(t);return l?e.jsxs("div",{style:{background:"rgba(236, 72, 153, 0.08)",borderRight:"3px solid #EC4899",borderRadius:"8px",padding:"10px 14px"},children:[e.jsx("span",{style:{color:"#F472B6",fontSize:"0.76rem",fontWeight:800,display:"block",marginBottom:"2px"},children:"د. مايسا:"}),e.jsx("p",{style:{margin:0,color:"#FFFFFF",fontSize:"0.98rem",fontWeight:650,lineHeight:1.75},children:t.replace(/^(د\.\s*مايسا|مايسا):?/i,"").trim()})]},r):g?e.jsxs("div",{style:{background:"rgba(56, 189, 248, 0.08)",borderRight:"3px solid #38BDF8",borderRadius:"8px",padding:"10px 14px"},children:[e.jsx("span",{style:{color:"#38BDF8",fontSize:"0.76rem",fontWeight:800,display:"block",marginBottom:"2px"},children:"الزوج:"}),e.jsx("p",{style:{margin:0,color:"#F0F9FF",fontSize:"0.98rem",fontWeight:650,lineHeight:1.75},children:t.replace(/^(الزوج|جوزها):?/i,"").trim()})]},r):m?e.jsx("div",{style:{color:"#94A3B8",fontSize:"0.82rem",fontStyle:"italic",padding:"2px 4px"},children:t},r):e.jsx("p",{style:{margin:"4px 0",color:"#E2E8F0",fontSize:"0.94rem",lineHeight:1.75},children:t},r)})})]},d):o.key==="interactiveCta"?e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(16, 185, 129, 0.14), rgba(5, 150, 105, 0.05))",border:"1.5px solid rgba(16, 185, 129, 0.35)",borderRadius:"14px",padding:"16px 20px",boxShadow:"0 4px 16px rgba(16, 185, 129, 0.1)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"10px"},children:[e.jsx(We,{className:"w-4 h-4 text-emerald-400"}),e.jsx("span",{style:{color:"#34D399",fontSize:"0.82rem",fontWeight:800},children:"📣 سؤال التفاعل والكومنتات (Engagement CTA)"})]}),e.jsx("div",{className:"space-y-2",children:o.lines.map((t,r)=>/^On Screen:?/i.test(t)?e.jsx("div",{style:{display:"inline-flex",alignItems:"center",gap:"6px",background:"rgba(16, 185, 129, 0.2)",border:"1px solid rgba(16, 185, 129, 0.4)",color:"#A7F3D0",fontSize:"0.82rem",fontWeight:700,padding:"4px 12px",borderRadius:"20px",marginTop:"4px"},children:e.jsxs("span",{children:["📱 على الشاشة: ",t.replace(/^On Screen:?/i,"").trim()]})},r):e.jsx("p",{style:{margin:0,color:"#ECFDF5",fontSize:"1rem",fontWeight:700,lineHeight:1.75},children:t},r))})]},d):o.key==="commercialCta"?e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(245, 158, 11, 0.12), rgba(16, 185, 129, 0.08))",border:"1.5px solid rgba(245, 158, 11, 0.35)",borderRadius:"14px",padding:"16px 20px",boxShadow:"0 4px 16px rgba(245, 158, 11, 0.1)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"8px"},children:[e.jsx(xe,{className:"w-4 h-4 text-amber-400"}),e.jsx("span",{style:{color:"#FBBF24",fontSize:"0.82rem",fontWeight:800},children:"🎯 الدعوة للاستشارة وحجز الجلسات (Booking CTA)"})]}),e.jsx("p",{style:{margin:0,color:"#FEF9C3",fontSize:"0.96rem",fontWeight:650,lineHeight:1.75},children:o.lines.join(" ")})]},d):null})]})}function _t(a){if(!a)return null;const i={},o=[{key:"hook",match:/^(hook|الـ\s*hook|الهوك|الافتتاحية)$/i},{key:"intro",match:/^(intro|المقدمة|الانترو)$/i},{key:"body",match:/^(body|صلب الموضوع|المحتوى)$/i},{key:"conclusion",match:/^(conclusion line|conclusion|end\s*line|الخاتمة|الخلاصة|الرسالة)$/i},{key:"cta",match:/^(cta|الدعوة للاتخاذ إجراء|الدعوة لاتخاذ إجراء|الدعوة)$/i},{key:"editor",match:/^(for editor.*|ملاحظة للمونتير|ملاحظات للمونتير)$/i}];let d=a.split(`
`).map(l=>l.trim()).filter(Boolean),t="header";i[t]=[];let r=!1;for(let l of d){const g=o.find(m=>m.match.test(l));g?(t=g.key,i[t]||(i[t]=[]),r=!0):i[t].push(l)}return r?i:null}function Ft({scriptText:a}){const i=_t(a);return i?e.jsxs("div",{className:"space-y-3.5",dir:"rtl",style:{textAlign:"right"},children:[i.header&&i.header.length>0&&e.jsx("div",{style:{background:"rgba(255, 255, 255, 0.03)",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",paddingBottom:"10px",marginBottom:"12px"},children:i.header.map((o,d)=>e.jsx("span",{style:{fontSize:"0.86rem",color:"#94A3B8",fontWeight:700,display:"block"},children:o},d))}),i.hook&&i.hook.length>0&&e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(245, 158, 11, 0.14), rgba(217, 119, 6, 0.05))",border:"1.5px solid rgba(245, 158, 11, 0.35)",borderRadius:"12px",padding:"14px 18px",boxShadow:"0 4px 16px rgba(245, 158, 11, 0.12)"},children:[e.jsxs("span",{style:{color:"#FBBF24",fontSize:"0.8rem",fontWeight:800,display:"flex",alignItems:"center",gap:"6px",marginBottom:"6px"},children:[e.jsx(K,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"الافتتاحية والهوك (The Hook):"})]}),e.jsxs("p",{style:{margin:0,color:"#FEF08A",fontSize:"1.04rem",fontWeight:750,lineHeight:1.75},children:['"',i.hook.join(" "),'"']})]}),i.intro&&i.intro.length>0&&e.jsxs("div",{style:{background:"rgba(14, 165, 233, 0.09)",border:"1px solid rgba(56, 189, 248, 0.25)",borderRadius:"12px",padding:"14px 18px"},children:[e.jsxs("span",{style:{color:"#38BDF8",fontSize:"0.78rem",fontWeight:800,display:"flex",alignItems:"center",gap:"6px",marginBottom:"6px"},children:[e.jsx(Te,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"المقدمة (Intro):"})]}),e.jsx("div",{style:{color:"#F0F9FF",fontSize:"0.96rem",lineHeight:1.85,fontWeight:500},children:i.intro.map((o,d)=>e.jsx("p",{style:{margin:d>0?"6px 0 0 0":0},children:o},d))})]}),i.body&&i.body.length>0&&e.jsxs("div",{style:{background:"rgba(15, 23, 42, 0.75)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"12px",padding:"16px 18px"},children:[e.jsx("span",{style:{color:"#94A3B8",fontSize:"0.78rem",fontWeight:800,display:"block",marginBottom:"8px"},children:"📝 صلب الموضوع والسيناريو (Body):"}),e.jsx("div",{className:"space-y-2",children:i.body.map((o,d)=>{const t=/^[•\-\*]/i.test(o),r=/^\d+[\.\)]/i.test(o)||/^(أولاً|ثانياً|ثالثاً|رابعاً):/i.test(o);return t||r?e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"8px",background:"rgba(255, 255, 255, 0.025)",border:"1px solid rgba(255, 255, 255, 0.05)",borderRadius:"8px",padding:"8px 12px"},children:[e.jsx("span",{style:{color:"#38BDF8",fontWeight:800,fontSize:"0.82rem",marginTop:"2px"},children:r?"✓":"•"}),e.jsx("span",{style:{color:"#E2E8F0",fontSize:"0.94rem",lineHeight:1.7},children:o.replace(/^[•\-\*]\s*/,"")})]},d):e.jsx("p",{style:{margin:"6px 0",color:"#CBD5E1",fontSize:"0.96rem",lineHeight:1.85},children:o},d)})})]}),i.conclusion&&i.conclusion.length>0&&e.jsxs("div",{style:{background:"rgba(168, 85, 247, 0.09)",border:"1px solid rgba(168, 85, 247, 0.25)",borderRadius:"12px",padding:"14px 18px"},children:[e.jsxs("span",{style:{color:"#C084FC",fontSize:"0.78rem",fontWeight:800,display:"flex",alignItems:"center",gap:"6px",marginBottom:"4px"},children:[e.jsx(ue,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"الرسالة الجوهرية (End Line / Conclusion):"})]}),e.jsxs("p",{style:{margin:0,color:"#F5F3FF",fontSize:"0.98rem",fontWeight:700,lineHeight:1.75},children:['"',i.conclusion.join(" "),'"']})]}),i.cta&&i.cta.length>0&&e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(16, 185, 129, 0.14), rgba(5, 150, 105, 0.05))",border:"1.5px solid rgba(16, 185, 129, 0.32)",borderRadius:"12px",padding:"14px 18px",boxShadow:"0 4px 16px rgba(16, 185, 129, 0.12)"},children:[e.jsxs("span",{style:{color:"#34D399",fontSize:"0.78rem",fontWeight:800,display:"flex",alignItems:"center",gap:"6px",marginBottom:"4px"},children:[e.jsx(We,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"الدعوة لإجراء (Call to Action / CTA):"})]}),e.jsx("p",{style:{margin:0,color:"#ECFDF5",fontSize:"0.96rem",fontWeight:650,lineHeight:1.75},children:i.cta.join(" ")})]}),i.editor&&i.editor.length>0&&e.jsxs("div",{style:{background:"rgba(245, 158, 11, 0.05)",border:"1px dashed rgba(245, 158, 11, 0.3)",borderRadius:"10px",padding:"14px 16px"},children:[e.jsxs("span",{style:{color:"#F59E0B",fontSize:"0.76rem",fontWeight:800,display:"flex",alignItems:"center",gap:"6px",marginBottom:"4px"},children:[e.jsx(ot,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"توجيهات المونتاج والإخراج (Editor Notes):"})]}),e.jsx("div",{style:{color:"#FDE68A",fontSize:"0.88rem",lineHeight:1.7},children:i.editor.map((o,d)=>e.jsx("p",{style:{margin:d>0?"4px 0 0 0":0},children:o},d))})]})]}):null}function Bt(a){if(!a)return{type:"empty",intro:"",items:[]};const i=a.split(`
`).map(t=>t.trim()).filter(Boolean),o=/^(\d+)[\.\-\)]\s*(.*)/;if(i.some(t=>o.test(t))){const t=[],r=[];let l=null;for(const g of i){const m=g.match(o);m?(l&&r.push(l),l={number:m[1],title:m[2].trim(),details:[]}):l?l.details.push(g):t.push(g)}return l&&r.push(l),{type:"numbered_ideas",intro:t.join(`
`),items:r}}return{type:"narrative",paragraphs:a.split(/\n\s*\n/).map(t=>t.trim()).filter(Boolean)}}function At({scriptText:a}){if(!a)return null;const i=Bt(a);return i.type==="numbered_ideas"?e.jsxs("div",{className:"space-y-4",dir:"rtl",style:{textAlign:"right"},children:[i.intro&&e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(56, 189, 248, 0.1), rgba(14, 165, 233, 0.03))",border:"1.5px solid rgba(56, 189, 248, 0.28)",borderRadius:"12px",padding:"14px 18px",boxShadow:"0 4px 18px rgba(0, 0, 0, 0.25)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"6px"},children:[e.jsx(ue,{className:"w-4 h-4 text-sky-400"}),e.jsx("span",{style:{color:"#38BDF8",fontSize:"0.82rem",fontWeight:800},children:"💡 الرؤية والتوجيه العام للمحتوى والتصوير:"})]}),e.jsx("p",{style:{margin:0,color:"#E0F2FE",fontSize:"0.94rem",lineHeight:1.75,fontWeight:550},children:i.intro})]}),e.jsx("div",{className:"space-y-3",children:i.items.map((o,d)=>e.jsx("div",{style:{background:"rgba(15, 23, 42, 0.75)",border:"1px solid rgba(255, 255, 255, 0.09)",borderRadius:"12px",padding:"16px 18px",transition:"all 0.25s ease"},className:"hover:border-sky-500/45 hover:bg-slate-900/90 shadow-sm",children:e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",gap:"12px"},children:[e.jsxs("span",{style:{background:"linear-gradient(135deg, rgba(56, 189, 248, 0.2), rgba(14, 165, 233, 0.1))",color:"#7DD3FC",border:"1px solid rgba(56, 189, 248, 0.35)",fontWeight:800,fontSize:"0.78rem",padding:"3px 10px",borderRadius:"8px",flexShrink:0,marginTop:"2px",display:"inline-flex",alignItems:"center",gap:"4px"},children:[e.jsx(ae,{className:"w-3 h-3 text-sky-400"}),e.jsxs("span",{children:["فكرة ",o.number]})]}),e.jsxs("div",{style:{flex:1},children:[e.jsx("h5",{style:{margin:0,color:"#FEF08A",fontSize:"1.02rem",fontWeight:750,lineHeight:1.6},children:o.title}),o.details.length>0&&e.jsxs("div",{style:{marginTop:"10px",paddingTop:"10px",borderTop:"1px solid rgba(255, 255, 255, 0.06)"},children:[e.jsxs("span",{style:{display:"inline-flex",alignItems:"center",gap:"5px",color:"#38BDF8",fontSize:"0.74rem",fontWeight:800,marginBottom:"6px"},children:[e.jsx(De,{className:"w-3 h-3 text-sky-400"}),e.jsx("span",{children:"فكرة المشهد والتنفيذ:"})]}),e.jsx("div",{className:"space-y-1.5",children:o.details.map((t,r)=>{const l=/^(Sensitive|Tags|Budget|Bundle|Product Launch)/i.test(t)||t.includes("/");return e.jsx("p",{style:{margin:0,color:l?"#93C5FD":"#CBD5E1",fontSize:"0.9rem",lineHeight:1.65,fontWeight:l?600:450,paddingRight:"8px",borderRight:"2px solid rgba(56, 189, 248, 0.3)"},children:t},r)})})]})]})]})},d))})]}):e.jsx(ze,{scriptText:a})}function Et({post:a,clientName:i,index:o}){const d=(a==null?void 0:a.caption)||"",t=d.split(`
`).map(f=>f.trim()).filter(Boolean),r=t.some(f=>/^(📍|📞|العنوان|تليفون|الهاتف|للحجز|للتواصل)/i.test(f)||/01\d{9}/.test(f));if(t.length>=4&&!r){const f=t.length>3&&(t[0].includes(":")||/^(عروض|خطة|أفكار|ملخص|استراتيجية)/i.test(t[0]))&&!/^["«]/.test(t[0]),v=f?t[0]:null,S=f?t.slice(1):t;return e.jsxs("div",{dir:"rtl",style:{background:"linear-gradient(180deg, rgba(15, 23, 42, 0.85) 0%, rgba(10, 18, 36, 0.95) 100%)",border:"1px solid rgba(255, 255, 255, 0.09)",borderRadius:"16px",padding:"20px 22px",boxShadow:"0 8px 30px rgba(0, 0, 0, 0.3)",textAlign:"right"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",paddingBottom:"14px",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",marginBottom:"16px",gap:"12px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px"},children:[e.jsx("div",{style:{width:"38px",height:"38px",borderRadius:"10px",background:"linear-gradient(135deg, rgba(245, 158, 11, 0.2), rgba(217, 119, 6, 0.15))",border:"1px solid rgba(245, 158, 11, 0.35)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.1rem",color:"#FBBF24"},children:"💡"}),e.jsxs("div",{children:[e.jsx("div",{style:{color:"#F8FAFC",fontWeight:750,fontSize:"0.98rem"},children:a.title||i||"بنك أفكار وزوايا ترويجية"}),e.jsx("div",{style:{color:"#94A3B8",fontSize:"0.78rem",fontWeight:500},children:i?`${i} · أفكار ومحاور معتمدة`:"بنك أفكار وزوايا ترويجية معتمدة"})]})]}),e.jsxs("span",{style:{fontSize:"0.76rem",fontWeight:800,color:"#38BDF8",background:"rgba(56, 189, 248, 0.12)",border:"1px solid rgba(56, 189, 248, 0.25)",padding:"4px 12px",borderRadius:"999px"},children:[S.length," زوايا وأفكار تسويقية"]})]}),a.direction&&e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(56, 189, 248, 0.1), rgba(14, 165, 233, 0.03))",border:"1px solid rgba(56, 189, 248, 0.25)",borderRadius:"12px",padding:"12px 16px",marginBottom:"16px",display:"flex",alignItems:"flex-start",gap:"10px"},children:[e.jsx("span",{style:{fontSize:"1.1rem",lineHeight:1},children:"🎯"}),e.jsxs("div",{children:[e.jsx("span",{style:{color:"#38BDF8",fontSize:"0.78rem",fontWeight:800,display:"block",marginBottom:"2px"},children:"الهدف والتوجيه الاستراتيجي:"}),e.jsx("span",{style:{color:"#F0F9FF",fontSize:"0.92rem",fontWeight:600,lineHeight:1.65},children:a.direction})]})]}),v&&e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(245, 158, 11, 0.14), rgba(217, 119, 6, 0.04))",border:"1.5px solid rgba(245, 158, 11, 0.35)",borderRadius:"12px",padding:"14px 18px",marginBottom:"16px",boxShadow:"0 4px 16px rgba(245, 158, 11, 0.08)"},children:[e.jsxs("span",{style:{color:"#FBBF24",fontSize:"0.78rem",fontWeight:800,display:"flex",alignItems:"center",gap:"6px",marginBottom:"4px"},children:[e.jsx(K,{className:"w-3.5 h-3.5"}),e.jsx("span",{children:"المحور الترويجي الأساسي (Core Campaign Hook):"})]}),e.jsx("p",{style:{margin:0,color:"#FEF08A",fontSize:"1.02rem",fontWeight:750,lineHeight:1.7},children:v})]}),e.jsx("div",{className:"space-y-2.5",children:S.map((w,_)=>{const C=w.match(/^["«](.*?)["»](?:\s*[—–-]\s*(.*))?$/),B=/^(bundle|باقة)/i.test(w),R=/(\?|؟)$/.test(w.trim());if(C){const T=C[1],O=C[2];return e.jsxs("div",{style:{background:"rgba(255, 255, 255, 0.03)",border:"1px solid rgba(255, 255, 255, 0.07)",borderRadius:"10px",padding:"12px 16px",display:"flex",alignItems:"flex-start",gap:"10px",transition:"all 0.2s ease"},className:"hover:border-sky-500/30 hover:bg-white/5",children:[e.jsx("span",{style:{color:"#38BDF8",fontSize:"0.82rem",marginTop:"3px",flexShrink:0},children:"✦"}),e.jsxs("div",{style:{flex:1},children:[e.jsxs("span",{style:{color:"#FFFFFF",fontWeight:750,fontSize:"0.96rem",lineHeight:1.7},children:['"',T,'"']}),O&&e.jsxs("span",{style:{color:"#94A3B8",fontSize:"0.88rem",fontWeight:500,marginRight:"8px",display:"inline-block"},children:["— ",O]})]})]},_)}return B?e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(16, 185, 129, 0.1), rgba(5, 150, 105, 0.03))",border:"1px solid rgba(16, 185, 129, 0.28)",borderRadius:"10px",padding:"12px 16px",display:"flex",alignItems:"center",gap:"10px",transition:"all 0.2s ease"},className:"hover:border-emerald-400/40 hover:bg-emerald-500/10",children:[e.jsx("span",{style:{background:"rgba(16, 185, 129, 0.2)",color:"#6EE7B7",border:"1px solid rgba(16, 185, 129, 0.4)",padding:"2px 8px",borderRadius:"6px",fontSize:"0.74rem",fontWeight:800,flexShrink:0},children:"🎁 Bundle باقة"}),e.jsx("p",{style:{margin:0,color:"#ECFDF5",fontSize:"0.95rem",fontWeight:700,lineHeight:1.6,flex:1},children:w.replace(/^(bundle|باقة)\s*:?/i,"").trim()})]},_):e.jsxs("div",{style:{background:"rgba(255, 255, 255, 0.025)",border:"1px solid rgba(255, 255, 255, 0.06)",borderRadius:"10px",padding:"12px 16px",display:"flex",alignItems:"flex-start",gap:"10px",transition:"all 0.2s ease"},className:"hover:border-sky-500/30 hover:bg-white/5",children:[e.jsx("span",{style:{color:R?"#C084FC":"#38BDF8",fontSize:"0.82rem",marginTop:"3px",flexShrink:0},children:R?"💬":"✦"}),e.jsx("p",{style:{margin:0,color:"#E2E8F0",fontSize:"0.94rem",fontWeight:600,lineHeight:1.7,flex:1},children:w})]},_)})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"14px",borderTop:"1px solid rgba(255, 255, 255, 0.06)",color:"#64748B",fontSize:"0.78rem",marginTop:"18px"},children:[e.jsxs("span",{style:{display:"flex",alignItems:"center",gap:"6px",color:"#7DD3FC",fontWeight:600},children:[e.jsx(ae,{className:"w-3.5 h-3.5 text-sky-400"}),e.jsx("span",{children:"أفكار وزوايا معتمدة جاهزة للتنفيذ"})]}),e.jsx("span",{style:{color:"#94A3B8",fontWeight:700},children:i||"Approved Strategy"})]})]})}const g=d.split(/\n\s*\n/).map(f=>f.trim()).filter(Boolean),m=[],n=[];return g.forEach(f=>{const v=f.split(`
`).map(w=>w.trim()).filter(Boolean);v.some(w=>/^(📍|📞|العنوان|تليفون|الهاتف|للحجز|للتواصل)/i.test(w)||/01\d{9}/.test(w))?v.forEach(w=>{/^(📍|📞|العنوان|تليفون|الهاتف|للحجز|للتواصل)/i.test(w)||/01\d{9}/.test(w)?n.push(w):m.push(w)}):m.push(f)}),e.jsxs("div",{dir:"rtl",style:{background:"linear-gradient(180deg, rgba(15, 23, 42, 0.85) 0%, rgba(10, 18, 36, 0.95) 100%)",border:"1px solid rgba(255, 255, 255, 0.09)",borderRadius:"16px",padding:"20px 22px",boxShadow:"0 8px 30px rgba(0, 0, 0, 0.3)",textAlign:"right"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",paddingBottom:"14px",borderBottom:"1px solid rgba(255, 255, 255, 0.08)",marginBottom:"16px",gap:"12px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px"},children:[e.jsx("div",{style:{width:"38px",height:"38px",borderRadius:"10px",background:"linear-gradient(135deg, rgba(56, 189, 248, 0.2), rgba(129, 140, 248, 0.2))",border:"1px solid rgba(56, 189, 248, 0.35)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.1rem",color:"#38BDF8"},children:"✍️"}),e.jsxs("div",{children:[e.jsx("div",{style:{color:"#F8FAFC",fontWeight:750,fontSize:"0.94rem"},children:a.title||i||"صياغة بوست معتمد"}),e.jsx("div",{style:{color:"#94A3B8",fontSize:"0.78rem",fontWeight:500},children:"صياغة محتوى سوشيال ميديا · Social Media Copy"})]})]}),e.jsx("span",{style:{fontSize:"0.76rem",fontWeight:800,color:"#34D399",background:"rgba(16, 185, 129, 0.12)",border:"1px solid rgba(16, 185, 129, 0.25)",padding:"4px 12px",borderRadius:"999px"},children:"محتوى معتمد للنشر"})]}),a.direction&&e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(56, 189, 248, 0.08), rgba(14, 165, 233, 0.02))",border:"1px dashed rgba(56, 189, 248, 0.3)",borderRadius:"10px",padding:"10px 14px",marginBottom:"16px",color:"#BAE6FD",fontSize:"0.86rem",lineHeight:1.6,fontWeight:600},children:["🎯 الهدف والتوجيه: ",a.direction]}),e.jsx("div",{style:{padding:"0 4px",marginBottom:"18px"},className:"space-y-3.5",children:m.map((f,v)=>f.includes("👇")||/^(قولنا|شاركنا|اكتب|مستنيين|تعالوا|اعمله منشن)/i.test(f)?e.jsx("div",{style:{background:"rgba(251, 191, 36, 0.08)",border:"1px solid rgba(251, 191, 36, 0.25)",borderRadius:"10px",padding:"12px 16px",color:"#FEF08A",fontSize:"0.96rem",fontWeight:650,lineHeight:1.75},children:f},v):e.jsx("p",{style:{margin:0,color:v===0?"#FFFFFF":"#E2E8F0",fontSize:v===0?"1.02rem":"0.96rem",fontWeight:v===0?650:500,lineHeight:1.85,whiteSpace:"pre-line"},children:f},v))}),n.length>0&&e.jsx("div",{style:{background:"rgba(255, 255, 255, 0.03)",border:"1px solid rgba(255, 255, 255, 0.07)",borderRadius:"12px",padding:"12px 14px",marginBottom:"14px",display:"flex",flexWrap:"wrap",gap:"10px",alignItems:"center"},children:n.map((f,v)=>{const S=f.includes("📍")||f.includes("العنوان"),w=f.match(/(01\d{9})/);return w?e.jsxs("a",{href:`tel:${w[1]}`,style:{display:"inline-flex",alignItems:"center",gap:"6px",padding:"6px 12px",borderRadius:"8px",background:"rgba(16, 185, 129, 0.12)",border:"1px solid rgba(16, 185, 129, 0.3)",color:"#6EE7B7",fontSize:"0.86rem",fontWeight:700,textDecoration:"none"},className:"hover:scale-105 active:scale-95 transition-transform",children:[e.jsx(Me,{className:"w-3.5 h-3.5"}),e.jsx("span",{dir:"ltr",children:f.replace(/📞/g,"").trim()})]},v):e.jsxs("div",{style:{display:"inline-flex",alignItems:"center",gap:"6px",padding:"6px 12px",borderRadius:"8px",background:S?"rgba(56, 189, 248, 0.1)":"rgba(255, 255, 255, 0.05)",border:`1px solid ${S?"rgba(56, 189, 248, 0.25)":"rgba(255, 255, 255, 0.08)"}`,color:S?"#BAE6FD":"#CBD5E1",fontSize:"0.86rem",fontWeight:600},children:[S?e.jsx(me,{className:"w-3.5 h-3.5 text-sky-400 shrink-0"}):null,e.jsx("span",{children:f.replace(/^[📍📞]\s*/,"")})]},v)})}),e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"12px",borderTop:"1px solid rgba(255, 255, 255, 0.06)",color:"#64748B",fontSize:"0.78rem"},children:[e.jsxs("span",{style:{display:"flex",alignItems:"center",gap:"6px",color:"#7DD3FC"},children:[e.jsx(ae,{className:"w-3.5 h-3.5 text-sky-400"}),e.jsx("span",{children:"صياغة معتمدة للنشر على منصات التواصل الاجتماعي"})]}),e.jsx("span",{style:{color:"#94A3B8",fontWeight:600},children:i||"Social Media Copy"})]})]})}function ze({scriptText:a}){const i=a.split(`

`).map(o=>o.trim()).filter(Boolean);if(i.length<=1){const o=a.split(`
`).map(d=>d.trim()).filter(Boolean);return e.jsx("div",{style:{background:"rgba(15, 23, 42, 0.7)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"12px",padding:"16px 18px"},dir:"rtl",children:o.map((d,t)=>e.jsx("p",{style:{margin:t>0?"8px 0 0 0":0,color:"#E2E8F0",fontSize:"0.96rem",lineHeight:1.85},children:d},t))})}return e.jsx("div",{className:"space-y-3",dir:"rtl",style:{textAlign:"right"},children:i.map((o,d)=>e.jsx("div",{style:{background:"rgba(15, 23, 42, 0.7)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"12px",padding:"14px 18px"},children:e.jsx("p",{style:{margin:0,color:"#E2E8F0",fontSize:"0.96rem",lineHeight:1.85,whiteSpace:"pre-line"},children:o})},d))})}function ce({scriptText:a}){if(!a)return null;const i=wt(a);return i==="podcast"?e.jsx(Nt,{scriptText:a}):i==="reel"?e.jsx(Ft,{scriptText:a}):i==="post_ideas"?e.jsx(At,{scriptText:a}):e.jsx(ze,{scriptText:a})}function Rt({isOpen:a,onClose:i,deliverable:o,client:d,category:t}){var O,G;const[r,l]=u.useState(0),[g,m]=u.useState(0);if(u.useEffect(()=>{l(0),m(0)},[o,a]),u.useEffect(()=>{const c=h=>{h.key==="Escape"&&a&&i()};return window.addEventListener("keydown",c),()=>window.removeEventListener("keydown",c)},[a,i]),!a||!o)return null;const n=ee[o.id]||null,v=(o.type==="pdf_deck"||o.type==="pdf")&&n&&n.images&&n.images.length>0,S=(O=o.sheetLinks)!=null&&O.length?o.sheetLinks:o.sheetUrl?[{label:"Open in Google Sheets",url:o.sheetUrl}]:n!=null&&n.sheetUrl?[{label:"Open in Google Sheets",url:n.sheetUrl}]:[],w=o.type==="sheet_plan"||o.type==="xlsx"||S.length>0||!!(n&&(n.type==="sheet_plan"||n.type==="xlsx"||n.sheetUrl)),_=(G=n==null?void 0:n.tables)!=null&&G.length?n.tables:n!=null&&n.headers&&(n!=null&&n.rows)?[{title:o.title,headers:n.headers,rows:n.rows}]:[],C=(t==null?void 0:t.accentColor)||(d==null?void 0:d.color)||"#38BDF8",B=c=>{l(h=>h===c?null:c)},R=S[g]||S[0]||null,T=(R==null?void 0:R.url)||o.sheetUrl||(n==null?void 0:n.sheetUrl)||"";return e.jsx(ge,{children:e.jsxs("div",{className:"work-modal open",id:"workModal",role:"dialog","aria-modal":"true",children:[e.jsx(A.div,{className:"work-modal__backdrop",id:"workModalBackdrop",onClick:i,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0}}),e.jsx("button",{className:"work-modal__close",id:"workModalClose","aria-label":"Close modal",onClick:i,children:e.jsx(he,{className:"w-5 h-5 text-white"})}),e.jsx(A.div,{className:"work-modal__container","data-lenis-prevent":"true",style:{overflowY:"auto",WebkitOverflowScrolling:"touch",overscrollBehavior:"contain",background:"var(--surface-card, #0a1120)",borderColor:"var(--border, rgba(255, 255, 255, 0.12))"},initial:{opacity:0,scale:.96,y:15},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.96,y:15},transition:{type:"spring",damping:26,stiffness:320},children:e.jsx("div",{className:"work-modal__content","data-lenis-prevent":"true",children:v?e.jsxs("div",{style:{width:"100%",maxWidth:"1100px",margin:"0 auto",padding:"20px 16px 36px 16px",boxSizing:"border-box"},children:[e.jsxs("div",{style:{marginBottom:"18px",padding:"14px 18px",background:"rgba(15, 23, 42, 0.75)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"14px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:"12px"},children:[e.jsxs("div",{dir:"rtl",className:"text-right",children:[e.jsx("span",{style:{fontSize:"0.75rem",fontWeight:700,color:C,background:`${C}18`,border:`1px solid ${C}35`,padding:"3px 10px",borderRadius:"6px",display:"inline-block",marginBottom:"6px"},children:d?d.name:n.client||""}),e.jsx("h3",{style:{fontSize:"1.15rem",fontWeight:800,color:"#F8FAFC",margin:0,lineHeight:1.4},children:n.title||o.title})]}),e.jsxs("span",{className:"text-xs font-semibold text-slate-300 bg-white/5 border border-white/10 px-3 py-1.5 rounded-lg flex items-center gap-1.5",children:[e.jsx(et,{className:"w-3.5 h-3.5 text-sky-400"}),e.jsxs("span",{children:[n.images.length," Slides"]})]})]}),n.images.map((c,h)=>{const p=c.startsWith("http")?c:`/shahd.ic/${c.replace(/^\//,"")}`;return e.jsxs("div",{style:{marginBottom:"18px",borderRadius:"12px",overflow:"hidden",border:"1px solid rgba(255, 255, 255, 0.1)",background:"#040914",boxShadow:"0 10px 30px rgba(0,0,0,0.6)",position:"relative",aspectRatio:"16/9",width:"100%"},children:[e.jsxs("div",{className:"absolute top-3 right-3 bg-slate-950/80 backdrop-blur-md text-slate-300 text-xs font-semibold px-2.5 py-1 rounded-md border border-white/10 z-10",children:[h+1," / ",n.images.length]}),e.jsx("img",{src:p,alt:`Slide ${h+1}`,style:{width:"100%",height:"100%",objectFit:"contain",display:"block"},loading:"eager",decoding:"async"})]},h)})]}):w?e.jsx("div",{style:{maxWidth:"640px",margin:"0 auto",padding:"40px 20px 48px 20px",textAlign:"center"},children:e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(15, 23, 42, 0.95), rgba(6, 78, 59, 0.25))",border:"1.5px solid rgba(16, 185, 129, 0.35)",borderRadius:"20px",padding:"38px 28px",boxShadow:"0 20px 50px rgba(0, 0, 0, 0.6), 0 0 30px rgba(16, 185, 129, 0.1)",display:"flex",flexDirection:"column",alignItems:"center",gap:"20px"},children:[e.jsx("div",{style:{width:"64px",height:"64px",borderRadius:"16px",background:"rgba(16, 185, 129, 0.15)",border:"1px solid rgba(16, 185, 129, 0.35)",display:"flex",alignItems:"center",justifyContent:"center",color:"#10B981"},children:e.jsx(I,{className:"w-8 h-8"})}),e.jsxs("div",{style:{display:"inline-flex",alignItems:"center",gap:"8px",background:`${C}18`,border:`1px solid ${C}30`,padding:"4px 14px",borderRadius:"8px"},children:[e.jsx("span",{style:{fontSize:"0.8rem",fontWeight:700,color:C},children:(d==null?void 0:d.name)||(n==null?void 0:n.client)||"Client Work"}),e.jsx("span",{style:{color:"rgba(255, 255, 255, 0.2)"},children:"•"}),e.jsx("span",{style:{fontSize:"0.8rem",color:"#94A3B8"},children:o.badge||"Google Sheets"})]}),e.jsx("h3",{style:{fontSize:"1.45rem",fontWeight:800,color:"#FFFFFF",margin:"0",lineHeight:1.4},dir:"rtl",children:o.title}),e.jsx("div",{style:{width:"100%",maxWidth:"420px",display:"flex",flexDirection:"column",gap:"12px",marginTop:"12px"},children:S.map((c,h)=>e.jsxs("a",{href:c.url,target:"_blank",rel:"noopener noreferrer",className:"hover:scale-102 active:scale-98 transition-all flex items-center justify-between gap-3 cursor-pointer shadow-lg shadow-emerald-950/40",style:{background:"#059669",color:"#FFFFFF",fontSize:"1rem",fontWeight:800,padding:"14px 24px",borderRadius:"12px",textDecoration:"none",width:"100%",boxSizing:"border-box"},children:[e.jsx(I,{className:"w-5 h-5 text-emerald-100 shrink-0"}),e.jsx("span",{className:"truncate",style:{flex:1,textAlign:"center"},children:c.label&&c.label!=="Open in Google Sheets"?c.label:"فتح في Google Sheets ↗"}),e.jsx(xe,{className:"w-4 h-4 text-emerald-200 shrink-0"})]},h))})]})}):e.jsxs("div",{className:"work-modal__info",style:{maxWidth:"1080px",margin:"0 auto",padding:"24px 18px 42px 18px"},children:[e.jsxs("div",{style:{background:"rgba(15, 23, 42, 0.75)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"16px",padding:"16px 20px",marginBottom:"20px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"12px"},children:[e.jsxs("div",{dir:"rtl",className:"text-right",children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"4px"},children:[e.jsx("span",{style:{fontSize:"0.75rem",fontWeight:700,color:C,background:`${C}18`,border:`1px solid ${C}30`,padding:"2px 8px",borderRadius:"6px"},children:(d==null?void 0:d.name)||"Client Work"}),e.jsx("span",{style:{fontSize:"0.78rem",color:"#94A3B8"},children:o.badge||o.title})]}),e.jsx("h3",{style:{fontSize:"1.28rem",fontWeight:800,color:"#FFFFFF",margin:0,lineHeight:1.3},children:o.title})]}),T&&e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",flexWrap:"wrap"},children:[S.length>1&&e.jsx("div",{style:{display:"flex",gap:"4px",background:"rgba(255,255,255,0.05)",padding:"3px",borderRadius:"8px",border:"1px solid rgba(255,255,255,0.08)"},children:S.map((c,h)=>e.jsx("button",{onClick:()=>m(h),style:{padding:"5px 12px",borderRadius:"6px",fontSize:"0.78rem",fontWeight:700,cursor:"pointer",border:"none",background:g===h?"rgba(56, 189, 248, 0.2)":"transparent",color:g===h?"#38BDF8":"#94A3B8",transition:"all 0.2s ease"},children:c.label||`Sheet 0${h+1}`},h))}),e.jsxs("a",{href:T,target:"_blank",rel:"noopener noreferrer",className:"hover:scale-105 active:scale-95 transition-all flex items-center gap-2 cursor-pointer",style:{background:"#059669",color:"#FFFFFF",fontSize:"0.86rem",fontWeight:700,padding:"10px 20px",borderRadius:"10px",textDecoration:"none",boxShadow:"0 4px 16px rgba(5, 150, 105, 0.35)"},children:[e.jsx(I,{className:"w-4 h-4"}),e.jsx("span",{children:"Open in Google Sheets"}),e.jsx(xe,{className:"w-3.5 h-3.5"})]})]})]}),e.jsxs("div",{className:"work-modal__desc",id:"workModalDesc",children:[(n==null?void 0:n.branchInfo)&&e.jsxs("div",{dir:"rtl",style:{background:"rgba(255, 255, 255, 0.03)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"12px",padding:"12px 16px",marginBottom:"16px",display:"flex",flexWrap:"wrap",gap:"12px",alignItems:"center",fontSize:"0.85rem",color:"#94A3B8",textAlign:"right"},children:[n.branchInfo.location&&e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:[e.jsx(me,{className:"w-3.5 h-3.5 text-sky-400"}),e.jsx("span",{style:{color:"#E2E8F0"},children:n.branchInfo.location})]}),n.branchInfo.specialty&&e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:[e.jsx(ae,{className:"w-3.5 h-3.5 text-amber-400"}),e.jsx("span",{style:{color:"#FDE68A"},children:n.branchInfo.specialty})]})]}),(n==null?void 0:n.campaignLine)&&e.jsxs("div",{dir:"rtl",style:{background:"rgba(56, 189, 248, 0.08)",border:"1px solid rgba(56, 189, 248, 0.25)",borderRadius:"12px",padding:"12px 16px",marginBottom:"16px",textAlign:"right"},children:[e.jsx("span",{style:{color:"#38BDF8",fontWeight:700,fontSize:"0.78rem",display:"block",marginBottom:"2px"},children:"شعار الحملة (Campaign Line):"}),e.jsx("div",{style:{color:"#FFFFFF",fontSize:"1.02rem",fontWeight:800},children:n.campaignLine})]}),(n==null?void 0:n.goal)&&!(n!=null&&n.days)&&e.jsxs("div",{dir:"rtl",style:{background:"rgba(16, 185, 129, 0.08)",border:"1px solid rgba(16, 185, 129, 0.22)",borderRadius:"12px",padding:"12px 16px",marginBottom:"16px",textAlign:"right"},children:[e.jsx("span",{style:{color:"#34D399",fontWeight:700,fontSize:"0.78rem",display:"block",marginBottom:"2px"},children:"الهدف التسويقي (Objective):"}),e.jsx("div",{style:{color:"#ECFDF5",fontSize:"0.94rem",lineHeight:1.7},children:n.goal})]}),(n==null?void 0:n.hook)&&e.jsxs("div",{dir:"rtl",style:{background:"rgba(245, 158, 11, 0.08)",border:"1px solid rgba(245, 158, 11, 0.22)",borderRadius:"12px",padding:"14px 18px",marginBottom:"18px",textAlign:"right"},children:[e.jsx("span",{style:{color:"#FBBF24",fontWeight:700,fontSize:"0.82rem",display:"block",marginBottom:"4px"},children:"استراتيجية وهدف المحتوى (Strategic Focus):"}),e.jsx("div",{style:{color:"#FEF9C3",fontSize:"0.96rem",lineHeight:1.8,fontWeight:500},children:n.hook})]}),w&&e.jsxs("div",{style:{background:"linear-gradient(135deg, rgba(5, 150, 105, 0.14), rgba(16, 185, 129, 0.05))",border:"1.5px solid rgba(16, 185, 129, 0.3)",borderRadius:"14px",padding:"16px 20px",marginBottom:"20px",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"14px"},children:[e.jsxs("div",{dir:"rtl",style:{textAlign:"right",maxWidth:"650px"},children:[e.jsx("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginBottom:"4px"},children:e.jsx("span",{style:{color:"#34D399",fontWeight:800,fontSize:"0.88rem"},children:"جدول ومخطط محتوى مباشر (Live Google Sheet)"})}),e.jsx("p",{style:{margin:0,color:"#A7F3D0",fontSize:"0.88rem",lineHeight:1.6},children:"المحتوى والجدول الزمني متاح مباشرة على Google Sheets لسهولة الفلترة والاطلاع الفوري."})]}),T&&e.jsxs("a",{href:T,target:"_blank",rel:"noopener noreferrer",style:{background:"#059669",color:"#FFFFFF",fontSize:"0.88rem",fontWeight:800,padding:"10px 20px",borderRadius:"10px",textDecoration:"none",display:"inline-flex",alignItems:"center",gap:"8px",boxShadow:"0 4px 16px rgba(5, 150, 105, 0.35)",transition:"all 0.2s ease"},className:"hover:scale-105 active:scale-95 cursor-pointer",children:[e.jsx(I,{className:"w-4 h-4"}),e.jsx("span",{children:"Open in Google Sheets ↗"})]})]}),_.length>0&&e.jsx("div",{style:{marginBottom:"22px"},children:_.map((c,h)=>{var p,k;return e.jsxs("div",{style:{background:"rgba(15, 23, 42, 0.65)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"14px",padding:"16px 18px",marginBottom:"16px"},children:[c.title&&e.jsx("h4",{style:{color:"#7DD3FC",fontSize:"1rem",fontWeight:800,margin:"0 0 12px 0",textAlign:"right"},dir:"rtl",children:c.title}),e.jsx("div",{style:{overflowX:"auto",WebkitOverflowScrolling:"touch",borderRadius:"10px",border:"1px solid rgba(255, 255, 255, 0.06)"},children:e.jsxs("table",{style:{width:"100%",minWidth:"550px",borderCollapse:"collapse",textAlign:"right",direction:"rtl",fontSize:"0.88rem"},children:[e.jsx("thead",{children:e.jsx("tr",{style:{background:"rgba(14, 165, 233, 0.12)",borderBottom:"1px solid rgba(56, 189, 248, 0.2)"},children:(p=c.headers)==null?void 0:p.map((x,F)=>e.jsx("th",{style:{padding:"12px 14px",color:"#BAE6FD",fontWeight:700,whiteSpace:"nowrap"},children:x},F))})}),e.jsx("tbody",{children:(k=c.rows)==null?void 0:k.map((x,F)=>e.jsx("tr",{style:{background:F%2===0?"rgba(255,255,255,0.015)":"rgba(255,255,255,0.035)",borderBottom:"1px solid rgba(255,255,255,0.05)"},children:x.map((W,z)=>e.jsx("td",{style:{padding:"12px 14px",color:z===1?"#FFFFFF":"#CBD5E1",fontWeight:z===1?600:400,lineHeight:1.6},children:W},z))},F))})]})})]},h)})}),(n==null?void 0:n.scenes)&&e.jsxs("div",{style:{marginTop:"4px"},children:[e.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"8px",marginBottom:"14px"},children:[n.duration&&e.jsxs("span",{className:"bg-white/5 text-slate-300 border border-white/10 px-3 py-1 rounded-lg text-xs font-semibold flex items-center gap-1.5",children:[e.jsx(Ee,{className:"w-3.5 h-3.5 text-sky-400"}),e.jsxs("span",{children:["Duration: ",n.duration]})]}),n.audio&&e.jsxs("span",{className:"bg-amber-500/10 text-amber-200 border border-amber-500/20 px-3 py-1 rounded-lg text-xs font-semibold flex items-center gap-1.5",children:[e.jsx(tt,{className:"w-3.5 h-3.5 text-amber-400"}),e.jsx("span",{dir:"rtl",children:n.audio})]})]}),n.concept&&e.jsxs("div",{dir:"rtl",style:{background:"rgba(15, 23, 42, 0.7)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"12px",padding:"14px 18px",marginBottom:"16px",color:"#CBD5E1",fontSize:"0.92rem",lineHeight:1.75,textAlign:"right"},children:[e.jsx("strong",{style:{color:"#38BDF8",display:"block",marginBottom:"4px",fontSize:"0.85rem"},children:"الفكرة العامة (Core Concept):"}),n.concept]}),e.jsx("div",{className:"deliverable-accordion space-y-3",style:{"--item-accent":C},children:n.scenes.map((c,h)=>{const p=r===h,k=String(h+1).padStart(2,"0"),x=c.num||`المشهد ${k}`,F=c.dialogue?c.dialogue.slice(0,65)+"...":c.visual?c.visual.slice(0,65)+"...":"";return e.jsxs("article",{className:`accordion-item ${p?"is-active":""}`,style:{background:"rgba(15, 23, 42, 0.75)",borderColor:p?"rgba(56, 189, 248, 0.35)":"rgba(255, 255, 255, 0.08)",borderRadius:"14px",overflow:"hidden",transition:"border-color 0.25s ease"},children:[e.jsxs("button",{type:"button",className:"accordion-item__trigger","aria-expanded":p,onClick:()=>B(h),style:{padding:"14px 18px",width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between",background:p?"rgba(255, 255, 255, 0.04)":"transparent",border:"none",cursor:"pointer",transition:"background 0.2s ease"},children:[e.jsxs("div",{className:"accordion-item__start",style:{display:"flex",alignItems:"center",gap:"12px"},children:[e.jsx("span",{className:"accordion-item__num-badge",style:{background:p?"rgba(56, 189, 248, 0.2)":"rgba(255, 255, 255, 0.06)",color:p?"#38BDF8":"#CBD5E1",fontWeight:800,padding:"4px 8px",borderRadius:"8px",fontSize:"0.8rem"},children:k}),e.jsxs("div",{className:"accordion-item__meta",dir:"rtl",style:{textAlign:"right"},children:[e.jsx("h4",{className:"accordion-item__title",style:{fontSize:"0.96rem",fontWeight:700,color:p?"#38BDF8":"#F8FAFC",margin:0,transition:"color 0.2s ease"},children:x}),!p&&F&&e.jsx("span",{className:"accordion-item__preview",style:{color:"#94A3B8",fontSize:"0.8rem",display:"block",marginTop:"3px"},children:F})]})]}),e.jsxs("div",{className:"accordion-item__end",style:{display:"flex",alignItems:"center",gap:"8px"},children:[e.jsxs("span",{className:"accordion-item__status-pill",style:{background:"rgba(255, 255, 255, 0.05)",color:"#94A3B8",borderColor:"rgba(255, 255, 255, 0.08)",fontSize:"0.74rem",padding:"3px 8px",borderRadius:"6px"},children:["Scene ",k]}),e.jsx("span",{className:"accordion-item__chevron",children:e.jsx(Q,{className:`w-4 h-4 text-slate-400 transition-transform duration-300 ${p?"rotate-180 text-sky-400":""}`})})]})]}),p&&e.jsx(A.div,{initial:{opacity:0,height:0},animate:{opacity:1,height:"auto"},exit:{opacity:0,height:0},transition:{duration:.25},className:"accordion-item__content",style:{display:"block",padding:"0",borderTop:"1px solid rgba(255, 255, 255, 0.08)"},dir:"rtl",children:e.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x md:divide-x-reverse divide-white/5",dir:"rtl",children:[e.jsxs("div",{style:{padding:"18px 20px",textAlign:"right"},children:[e.jsx("span",{style:{color:"#7DD3FC",fontSize:"0.76rem",fontWeight:700,display:"block",marginBottom:"8px"},children:"🎙️ الحوار والأداء الصوتي (Dialogue / VO):"}),e.jsx("p",{style:{margin:0,color:"#FFFFFF",fontSize:"1rem",fontWeight:500,lineHeight:1.9},children:c.dialogue||"—"})]}),e.jsxs("div",{style:{padding:"18px 20px",textAlign:"right",background:"rgba(0, 0, 0, 0.18)"},children:[c.visual&&e.jsxs("div",{style:{marginBottom:c.sfx||c.textOnScreen?"12px":"0"},children:[e.jsx("span",{style:{color:"#38BDF8",fontSize:"0.76rem",fontWeight:700,display:"block",marginBottom:"4px"},children:"🎬 اللقطة والتوجيه البصري (Video):"}),e.jsx("p",{style:{margin:0,color:"#94A3B8",fontSize:"0.9rem",lineHeight:1.75},children:c.visual})]}),c.textOnScreen&&e.jsxs("div",{style:{marginTop:"10px",background:"rgba(168, 85, 247, 0.08)",border:"1px solid rgba(168, 85, 247, 0.22)",borderRadius:"8px",padding:"8px 12px"},children:[e.jsx("span",{style:{color:"#C084FC",fontSize:"0.74rem",fontWeight:700,display:"block",marginBottom:"2px"},children:"النص على الشاشة (On-Screen Text):"}),e.jsx("p",{style:{margin:0,color:"#F3E8FF",fontSize:"0.88rem",fontWeight:600},children:c.textOnScreen})]}),c.sfx&&e.jsxs("div",{style:{marginTop:"10px",background:"rgba(245, 158, 11, 0.07)",border:"1px solid rgba(245, 158, 11, 0.2)",borderRadius:"8px",padding:"8px 12px"},children:[e.jsx("span",{style:{color:"#F59E0B",fontSize:"0.74rem",fontWeight:700,display:"block",marginBottom:"2px"},children:"🔊 المؤثرات الصوتية (SFX):"}),e.jsx("p",{style:{margin:0,color:"#FDE68A",fontSize:"0.86rem",lineHeight:1.6},children:c.sfx})]})]})]})})]},h)})}),n.cta&&e.jsxs("div",{dir:"rtl",style:{marginTop:"16px",background:"rgba(16, 185, 129, 0.08)",border:"1px solid rgba(16, 185, 129, 0.22)",borderRadius:"12px",padding:"14px 18px",textAlign:"right"},children:[e.jsx("span",{style:{color:"#34D399",fontWeight:700,fontSize:"0.8rem",display:"block",marginBottom:"4px"},children:"دعوة لاتخاذ إجراء (CTA):"}),e.jsx("div",{style:{color:"#ECFDF5",fontSize:"0.94rem",lineHeight:1.75},children:n.cta})]}),n.notes&&e.jsxs("div",{style:{background:"rgba(255, 255, 255, 0.03)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"10px",padding:"12px 16px",marginTop:"14px",textAlign:"right"},dir:"rtl",children:[e.jsx("span",{style:{color:"#94A3B8",fontWeight:700,fontSize:"0.8rem",display:"block",marginBottom:"2px"},children:"ملاحظات الإنتاج (Production Notes):"}),e.jsx("span",{style:{color:"#CBD5E1",fontSize:"0.88rem",lineHeight:1.6},children:n.notes})]})]}),(n==null?void 0:n.trends)&&n.trends.length>0&&e.jsxs("div",{style:{marginBottom:"22px"},children:[e.jsx("h4",{style:{color:"#38BDF8",fontSize:"1rem",fontWeight:800,margin:"0 0 14px 0",textAlign:"right"},dir:"rtl",children:"مكتبة الأفكار والمراجع المعتمدة (Trends & References):"}),e.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-3",children:n.trends.map((c,h)=>e.jsxs("div",{style:{background:"rgba(15, 23, 42, 0.7)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"12px",padding:"14px 16px",display:"flex",flexDirection:"column",justifyContent:"space-between",gap:"10px"},children:[e.jsxs("div",{dir:"rtl",style:{textAlign:"right"},children:[c.num&&e.jsxs("span",{style:{fontSize:"0.75rem",fontWeight:800,color:"#F59E0B",background:"rgba(245, 158, 11, 0.15)",padding:"2px 8px",borderRadius:"6px",display:"inline-block",marginBottom:"6px"},children:["Ref ",c.num]}),e.jsx("h5",{style:{margin:0,color:"#F8FAFC",fontSize:"0.92rem",fontWeight:700,lineHeight:1.6},children:c.title})]}),c.link&&e.jsx("div",{style:{display:"flex",justifyContent:"flex-start"},children:e.jsxs("a",{href:c.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:"6px",fontSize:"0.8rem",fontWeight:700,color:"#E1306C",background:"rgba(225, 48, 108, 0.12)",border:"1px solid rgba(225, 48, 108, 0.3)",padding:"6px 12px",borderRadius:"8px",textDecoration:"none",transition:"all 0.2s ease"},className:"hover:scale-105 active:scale-95 cursor-pointer",children:[e.jsx("i",{className:"fa-brands fa-instagram"}),e.jsx("span",{children:"Open Instagram Reel ↗"})]})})]},h))})]}),(n==null?void 0:n.episodes)&&n.episodes.length>0&&e.jsxs("div",{style:{marginBottom:"22px"},children:[e.jsx("h4",{style:{color:"#EC4899",fontSize:"1rem",fontWeight:800,margin:"0 0 14px 0",textAlign:"right"},dir:"rtl",children:"حلقات البودكاست وسلسلة الفيديوهات (Podcast & Video Series):"}),e.jsx("div",{className:"deliverable-accordion",style:{"--item-accent":"#EC4899"},children:n.episodes.map((c,h)=>{const p=r===h,k=String(h+1).padStart(2,"0");return e.jsxs("article",{className:`accordion-item ${p?"is-active":""}`,style:{background:"rgba(15, 23, 42, 0.65)",borderColor:"rgba(255,255,255,0.08)",marginBottom:"10px",borderRadius:"12px"},children:[e.jsxs("button",{type:"button",className:"accordion-item__trigger","aria-expanded":p,onClick:()=>B(h),style:{padding:"14px 18px"},children:[e.jsxs("div",{className:"accordion-item__start",children:[e.jsx("span",{className:"accordion-item__num-badge",style:{background:"rgba(236, 72, 153, 0.18)",color:"#F472B6"},children:k}),e.jsxs("div",{className:"accordion-item__meta",dir:"rtl",style:{textAlign:"right"},children:[e.jsx("h4",{className:"accordion-item__title",style:{fontSize:"0.98rem",fontWeight:700,color:"#F8FAFC"},children:c.title}),c.hook&&e.jsx("span",{className:"accordion-item__preview",style:{color:"#94A3B8",fontSize:"0.82rem"},children:c.hook})]})]}),e.jsxs("div",{className:"accordion-item__end",children:[e.jsx("span",{className:"accordion-item__status-pill",style:{background:"rgba(236, 72, 153, 0.1)",color:"#F472B6",borderColor:"rgba(236, 72, 153, 0.25)"},children:"Podcast Episode"}),e.jsx("span",{className:"accordion-item__chevron",children:e.jsx(Q,{className:`w-4 h-4 text-slate-400 transition-transform duration-300 ${p?"rotate-180":""}`})})]})]}),p&&e.jsxs(A.div,{initial:{opacity:0,height:0},animate:{opacity:1,height:"auto"},exit:{opacity:0,height:0},className:"accordion-item__content",style:{display:"block",padding:"18px 20px",borderTop:"1px solid rgba(255,255,255,0.06)"},dir:"rtl",children:[c.hook&&e.jsxs("div",{style:{background:"rgba(236, 72, 153, 0.08)",border:"1px solid rgba(236, 72, 153, 0.2)",borderRadius:"10px",padding:"10px 14px",marginBottom:"14px",textAlign:"right"},children:[e.jsx("span",{style:{color:"#F472B6",fontWeight:700,fontSize:"0.82rem",display:"block",marginBottom:"2px"},children:"الهوك والافتتاحية:"}),e.jsx("span",{style:{color:"#FDF2F8",fontSize:"0.94rem",lineHeight:1.7},children:c.hook})]}),c.script&&e.jsx(ce,{scriptText:c.script})]})]},h)})})]}),(n==null?void 0:n.concepts)&&n.concepts.length>0&&e.jsxs("div",{style:{marginBottom:"22px"},children:[e.jsx("h4",{style:{color:"#38BDF8",fontSize:"1rem",fontWeight:800,margin:"0 0 14px 0",textAlign:"right"},dir:"rtl",children:"الأفكار الإبداعية التجريبية (Creative Concepts):"}),e.jsx("div",{className:"space-y-4",children:n.concepts.map((c,h)=>e.jsxs("div",{style:{background:"rgba(15, 23, 42, 0.75)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"14px",padding:"18px"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"12px",flexWrap:"wrap",gap:"8px"},children:[e.jsx("span",{style:{fontSize:"0.8rem",fontWeight:700,color:"#38BDF8",background:"rgba(56, 189, 248, 0.15)",padding:"3px 10px",borderRadius:"6px"},children:c.badge||c.num}),c.duration&&e.jsxs("span",{className:"text-xs text-slate-400 flex items-center gap-1",children:[e.jsx(Ee,{className:"w-3.5 h-3.5 text-sky-400"}),e.jsx("span",{children:c.duration})]})]}),e.jsx("h4",{style:{color:"#FFFFFF",fontSize:"1.05rem",fontWeight:800,margin:"0 0 8px 0",textAlign:"right"},dir:"rtl",children:c.title}),c.style&&e.jsx("p",{style:{color:"#94A3B8",fontSize:"0.88rem",margin:"0 0 14px 0",textAlign:"right"},dir:"rtl",children:c.style}),c.scenes&&e.jsx("div",{className:"space-y-3 mt-3",children:c.scenes.map((p,k)=>e.jsxs("div",{style:{background:"rgba(255, 255, 255, 0.02)",border:"1px solid rgba(255, 255, 255, 0.06)",borderRadius:"10px",padding:"12px 14px",textAlign:"right"},dir:"rtl",children:[e.jsx("span",{style:{color:"#7DD3FC",fontSize:"0.82rem",fontWeight:700,display:"block",marginBottom:"4px"},children:p.num}),p.visual&&e.jsxs("p",{style:{margin:"3px 0",color:"#CBD5E1",fontSize:"0.88rem",lineHeight:1.6},children:[e.jsx("strong",{style:{color:"#94A3B8"},children:"البصريات:"})," ",p.visual]}),p.dialogue&&e.jsxs("p",{style:{margin:"3px 0",color:"#FFFFFF",fontSize:"0.92rem",lineHeight:1.7},children:[e.jsx("strong",{style:{color:"#7DD3FC"},children:"الحوار:"})," ",p.dialogue]}),p.sfx&&e.jsxs("p",{style:{margin:"3px 0",color:"#FDE68A",fontSize:"0.84rem"},children:[e.jsx("strong",{style:{color:"#F59E0B"},children:"SFX:"})," ",p.sfx]})]},k))})]},h))})]}),(n==null?void 0:n.reels)&&e.jsx("div",{style:{marginTop:"4px"},children:e.jsx("div",{className:"deliverable-accordion",style:{"--item-accent":C},children:n.reels.map((c,h)=>{const p=r===h,k=String(h+1).padStart(2,"0"),x=c.answer||c.script||"";return e.jsxs("article",{className:`accordion-item ${p?"is-active":""}`,style:{background:"rgba(15, 23, 42, 0.6)",borderColor:"rgba(255,255,255,0.08)",marginBottom:"10px",borderRadius:"12px"},children:[e.jsxs("button",{type:"button",className:"accordion-item__trigger","aria-expanded":p,onClick:()=>B(h),style:{padding:"14px 18px"},children:[e.jsxs("div",{className:"accordion-item__start",children:[e.jsx("span",{className:"accordion-item__num-badge",style:{background:"rgba(255,255,255,0.06)",color:"#CBD5E1"},children:k}),e.jsxs("div",{className:"accordion-item__meta",dir:"rtl",style:{textAlign:"right"},children:[e.jsx("h4",{className:"accordion-item__title",style:{fontSize:"0.98rem",fontWeight:700,color:"#F8FAFC"},children:c.title}),c.hook&&e.jsx("span",{className:"accordion-item__preview",style:{color:"#94A3B8",fontSize:"0.82rem"},children:c.hook})]})]}),e.jsxs("div",{className:"accordion-item__end",children:[e.jsx("span",{className:"accordion-item__status-pill",style:{background:"rgba(255,255,255,0.05)",color:"#94A3B8",borderColor:"rgba(255,255,255,0.08)"},children:"Reel Script"}),e.jsx("span",{className:"accordion-item__chevron",children:e.jsx(Q,{className:`w-4 h-4 text-slate-400 transition-transform duration-300 ${p?"rotate-180":""}`})})]})]}),p&&e.jsx(A.div,{initial:{opacity:0,height:0},animate:{opacity:1,height:"auto"},exit:{opacity:0,height:0},className:"accordion-item__content",style:{display:"block",padding:"18px",borderTop:"1px solid rgba(255,255,255,0.06)"},dir:"rtl",children:e.jsx(ce,{scriptText:x})})]},h)})})}),(n==null?void 0:n.posts)&&e.jsx("div",{style:{marginTop:"4px"},children:e.jsx("div",{className:"deliverable-accordion",style:{"--item-accent":C},children:n.posts.map((c,h)=>{const p=r===h,k=c.title||c.topic||`بوست ${h+1}`,x=k.replace(/^بوست\s*\d+\s*[·\-:]\s*/i,"").trim()||k,F=o.badge||"منشور معتمد للنشر";return e.jsxs("article",{className:`accordion-item ${p?"is-active":""}`,style:{background:"rgba(15, 23, 42, 0.6)",borderColor:"rgba(255,255,255,0.08)",marginBottom:"10px",borderRadius:"12px"},children:[e.jsxs("button",{type:"button",className:"accordion-item__trigger","aria-expanded":p,onClick:()=>B(h),style:{padding:"14px 18px"},children:[e.jsxs("div",{className:"accordion-item__start",children:[e.jsxs("span",{style:{background:"rgba(56, 189, 248, 0.12)",color:"#38BDF8",border:"1px solid rgba(56, 189, 248, 0.25)",borderRadius:"8px",padding:"4px 10px",fontSize:"0.78rem",fontWeight:750,display:"flex",alignItems:"center",gap:"5px",flexShrink:0},children:[e.jsx(q,{className:"w-3.5 h-3.5"}),e.jsxs("span",{children:["بوست ",h+1]})]}),e.jsxs("div",{className:"accordion-item__meta",dir:"rtl",style:{textAlign:"right"},children:[e.jsx("h4",{className:"accordion-item__title",style:{fontSize:"0.98rem",fontWeight:700,color:"#F8FAFC"},children:x}),c.caption&&e.jsxs("span",{className:"accordion-item__preview",style:{color:"#94A3B8",fontSize:"0.82rem"},children:[c.caption.split(`
`)[0].slice(0,70),"..."]})]})]}),e.jsxs("div",{className:"accordion-item__end",children:[e.jsx("span",{className:"accordion-item__status-pill",style:{background:"rgba(56, 189, 248, 0.08)",color:"#7DD3FC",borderColor:"rgba(56, 189, 248, 0.2)"},children:F}),e.jsx("span",{className:"accordion-item__chevron",children:e.jsx(Q,{className:`w-4 h-4 text-slate-400 transition-transform duration-300 ${p?"rotate-180":""}`})})]})]}),p&&e.jsx(A.div,{initial:{opacity:0,height:0},animate:{opacity:1,height:"auto"},exit:{opacity:0,height:0},className:"accordion-item__content",style:{display:"block",padding:"14px 16px",borderTop:"1px solid rgba(255,255,255,0.06)"},dir:"rtl",children:e.jsx(Et,{post:c,clientName:o.client||(d==null?void 0:d.name)||n.client,index:h})})]},h)})})}),(n==null?void 0:n.days)&&e.jsxs("div",{style:{marginTop:"4px"},children:[n.strategy&&e.jsxs("div",{dir:"rtl",style:{background:"rgba(15, 23, 42, 0.7)",border:"1px solid rgba(255, 255, 255, 0.08)",borderRadius:"12px",padding:"16px 18px",marginBottom:"16px",color:"#E2E8F0",fontSize:"0.94rem",lineHeight:1.8,textAlign:"right"},children:[e.jsx("strong",{style:{color:"#F59E0B",display:"block",marginBottom:"4px",fontSize:"0.85rem"},children:"Launch Strategy:"}),n.strategy]}),e.jsx("div",{className:"deliverable-accordion",style:{"--item-accent":C},children:n.days.map((c,h)=>{var x;const p=r===h,k=String(h+1).padStart(2,"0");return e.jsxs("article",{className:`accordion-item ${p?"is-active":""}`,style:{background:"rgba(15, 23, 42, 0.6)",borderColor:"rgba(255,255,255,0.08)",marginBottom:"10px",borderRadius:"12px"},children:[e.jsxs("button",{type:"button",className:"accordion-item__trigger","aria-expanded":p,onClick:()=>B(h),style:{padding:"14px 18px"},children:[e.jsxs("div",{className:"accordion-item__start",children:[e.jsx("span",{className:"accordion-item__num-badge",style:{background:"rgba(255,255,255,0.06)",color:"#CBD5E1"},children:k}),e.jsxs("div",{className:"accordion-item__meta",dir:"rtl",style:{textAlign:"right"},children:[e.jsx("h4",{className:"accordion-item__title",style:{fontSize:"0.98rem",fontWeight:700,color:"#F8FAFC"},children:c.dayName}),c.goal&&e.jsx("span",{className:"accordion-item__preview",style:{color:"#94A3B8",fontSize:"0.82rem"},children:c.goal})]})]}),e.jsxs("div",{className:"accordion-item__end",children:[e.jsx("span",{className:"accordion-item__status-pill",style:{background:"rgba(255,255,255,0.05)",color:"#94A3B8",borderColor:"rgba(255,255,255,0.08)"},children:c.badge||`Day ${k}`}),e.jsx("span",{className:"accordion-item__chevron",children:e.jsx(Q,{className:`w-4 h-4 text-slate-400 transition-transform duration-300 ${p?"rotate-180":""}`})})]})]}),p&&e.jsxs(A.div,{initial:{opacity:0,height:0},animate:{opacity:1,height:"auto"},exit:{opacity:0,height:0},className:"accordion-item__content",style:{display:"block",padding:"18px",borderTop:"1px solid rgba(255,255,255,0.06)"},dir:"rtl",children:[c.goal&&e.jsxs("div",{style:{background:"rgba(14, 165, 233, 0.08)",border:"1px solid rgba(56, 189, 248, 0.2)",borderRadius:"10px",padding:"10px 14px",marginBottom:"14px",textAlign:"right"},children:[e.jsx("span",{style:{color:"#7DD3FC",fontWeight:700,fontSize:"0.82rem",display:"block",marginBottom:"2px"},children:"الهدف:"}),e.jsx("span",{style:{color:"#F0F9FF",fontSize:"0.92rem",lineHeight:1.7},children:c.goal})]}),c.mainContent&&e.jsxs("div",{style:{background:"rgba(2, 6, 23, 0.5)",border:"1px solid rgba(255, 255, 255, 0.06)",borderRadius:"12px",padding:"16px",marginBottom:"12px",textAlign:"right"},children:[e.jsx("strong",{style:{color:"#F8FAFC",fontSize:"0.96rem",display:"block",marginBottom:"8px"},children:c.mainContent.type||c.mainContent.title||"محتوى اليوم"}),c.mainContent.concept&&e.jsx("p",{style:{margin:"0 0 12px 0",color:"#94A3B8",fontSize:"0.9rem",lineHeight:1.7},children:c.mainContent.concept}),(x=c.mainContent.scenes)==null?void 0:x.map((F,W)=>e.jsxs("div",{style:{background:"rgba(255,255,255,0.02)",border:"1px solid rgba(255,255,255,0.06)",borderRadius:"8px",padding:"12px 14px",marginBottom:"8px"},children:[e.jsx("span",{style:{color:"#38BDF8",fontSize:"0.8rem",fontWeight:700,display:"block",marginBottom:"4px"},children:F.num}),F.visual&&e.jsxs("p",{style:{margin:"3px 0",color:"#CBD5E1",fontSize:"0.88rem",lineHeight:1.65},children:[e.jsx("strong",{style:{color:"#94A3B8"},children:"اللقطة:"})," ",F.visual]}),F.text&&e.jsxs("p",{style:{margin:"3px 0",color:"#FEF08A",fontSize:"0.9rem",lineHeight:1.7},children:[e.jsx("strong",{style:{color:"#F59E0B"},children:"النص:"})," ",F.text]})]},W))]})]})]},h)})})]}),!(n!=null&&n.scenes)&&!(n!=null&&n.episodes)&&!(n!=null&&n.reels)&&!(n!=null&&n.posts)&&!(n!=null&&n.days)&&_.length===0&&!(n!=null&&n.trends)&&!(n!=null&&n.concepts)&&((n==null?void 0:n.script)||(n==null?void 0:n.answer))&&e.jsx("div",{style:{marginTop:"4px"},dir:"rtl",children:e.jsx(ce,{scriptText:n.script||n.answer})}),!n&&!T&&e.jsx("div",{dir:"rtl",style:{fontSize:"0.95rem",lineHeight:1.8,color:"#CBD5E1",marginTop:"8px",background:"rgba(15, 23, 42, 0.6)",padding:"20px 22px",borderRadius:"14px",border:"1px solid rgba(255, 255, 255, 0.08)",textAlign:"right"},children:e.jsx("p",{style:{color:"#94A3B8",margin:0,lineHeight:1.8},children:o.desc||"Approved strategic deliverable document."})})]})]})})})]})})}function Mt(){const[a,i]=u.useState(!1),[o,d]=u.useState({isOpen:!1,categoryKey:"medical"}),[t,r]=u.useState({isOpen:!1,deliverable:null,client:null,category:null}),[l,g]=u.useState(()=>{try{return localStorage.getItem("shahd_theme")||"light"}catch{return"light"}}),m=u.useRef(null);u.useEffect(()=>{document.documentElement.setAttribute("data-theme",l),l==="dark"?(document.documentElement.classList.add("dark"),document.body.classList.add("dark")):(document.documentElement.classList.remove("dark"),document.body.classList.remove("dark"));try{localStorage.setItem("shahd_theme",l)}catch{}},[l]);const n=()=>{g(_=>_==="light"?"dark":"light")};u.useEffect(()=>{if(!window.matchMedia("(prefers-reduced-motion: reduce)").matches)try{let C=function(T){m.current&&m.current.raf(T),R=requestAnimationFrame(C)};const B=new Ge({duration:1.15,easing:T=>Math.min(1,1.001-Math.pow(2,-10*T)),orientation:"vertical",gestureOrientation:"vertical",smoothWheel:!0,wheelMultiplier:.92,touchMultiplier:1.5,smoothTouch:!1});m.current=B,window.__lenis=B;let R;return R=requestAnimationFrame(C),()=>{R&&cancelAnimationFrame(R),m.current&&(m.current.destroy(),m.current=null,window.__lenis=null)}}catch(C){console.warn("Lenis could not be initialized:",C)}},[]),u.useEffect(()=>{var C,B;o.isOpen||t.isOpen?(document.body.style.overflow="hidden",document.body.classList.add("modal-open"),(C=m.current)==null||C.stop()):(document.body.style.overflow="",document.body.classList.remove("modal-open"),(B=m.current)==null||B.start())},[o.isOpen,t.isOpen]);const f=_=>{d({isOpen:!0,categoryKey:_||"medical"})},v=()=>{d(_=>({..._,isOpen:!1}))},S=(_,C,B)=>{r({isOpen:!0,deliverable:_,client:C,category:B})},w=()=>{r({isOpen:!1,deliverable:null,client:null,category:null})};return e.jsxs("div",{className:"app-root",children:[e.jsx(dt,{onLoaded:()=>i(!0)}),e.jsx(ct,{theme:l}),e.jsx(pt,{}),e.jsx(ht,{}),e.jsx(xt,{isLoaded:a,theme:l,onToggleTheme:n}),e.jsxs("main",{id:"main-content",children:[e.jsx(gt,{onOpenFolder:f}),e.jsx(mt,{}),e.jsx(ut,{}),e.jsx(yt,{}),e.jsx(jt,{})]}),e.jsx(vt,{}),e.jsx(kt,{isOpen:o.isOpen,categoryKey:o.categoryKey,onClose:v,onOpenDeliverable:S}),e.jsx(Rt,{isOpen:t.isOpen,deliverable:t.deliverable,client:t.client,category:t.category,onClose:w})]})}lt.createRoot(document.getElementById("root")).render(e.jsx($e.StrictMode,{children:e.jsx(Mt,{})}))});export default Dt();
